...
pub unsafe extern "C" fn sqlite3_exec(
    ...
    unsafe {
            ...
            && *zSql.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int != 0
        {
            ...
            if pStmt.is_null() {
                ...
                loop {
                        ...
                        && (SQLITE_ROW == rc
                            || SQLITE_DONE == rc && callbackIsInit == 0
                                && (*db).flags as ::core::ffi::c_ulonglong
                                    & SQLITE_NullCallback as ::core::ffi::c_ulonglong != 0)
                    {
                        if callbackIsInit == 0 {
                            nCol = sqlite3_column_count(pStmt);
                            azCols = sqlite3DbMallocRaw(
                                db,
                                ((2 as ::core::ffi::c_int * nCol + 1 as ::core::ffi::c_int)
                                    as usize)
                                    .wrapping_mul(
                            ...
                            while i < nCol {
                                let ref mut c2rust_fresh0 = *azCols.offset(i as isize);
                                *c2rust_fresh0 = sqlite3_column_name(pStmt, i)
                        ...
                        if rc == SQLITE_ROW {
                            azVals = azCols.offset(nCol as isize)
                                as *mut *mut ::core::ffi::c_char;
                            i = 0 as ::core::ffi::c_int;
                            while i < nCol {
                                let ref mut c2rust_fresh1 = *azVals.offset(i as isize);
                                *c2rust_fresh1 = sqlite3_column_text(pStmt, i)
                                    as *mut ::core::ffi::c_char;
                            ...
                            let ref mut c2rust_fresh2 = *azVals.offset(i as isize);
                            *c2rust_fresh2 = ::core::ptr::null_mut::<
                                ::core::ffi::c_char,
                            >();
                        }
                        if xCallback
                            ...
                            )(pArg, nCol, azVals, azCols) != 0
                        {
                            rc = SQLITE_ABORT;
                            sqlite3VdbeFinalize(pStmt as *mut Vdbe);
                            pStmt = ::core::ptr::null_mut::<sqlite3_stmt>();
                    ...
                    rc = sqlite3VdbeFinalize(pStmt as *mut Vdbe);
                    pStmt = ::core::ptr::null_mut::<sqlite3_stmt>();
                    zSql = zLeftover;
                    while *(&raw const sqlite3CtypeMap as *const ::core::ffi::c_uchar)
                        .offset(
                            *zSql.offset(0 as ::core::ffi::c_int as isize)
                ...
                sqlite3DbFree(db, azCols as *mut ::core::ffi::c_void);
        ...
        if rc != SQLITE_OK && !pzErrMsg.is_null() {
            *pzErrMsg = sqlite3DbStrDup(
