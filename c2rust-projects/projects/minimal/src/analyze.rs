            ...
            if !(!pOnlyIdx.is_null() && pOnlyIdx != pIdx) {
                ...
                sqlite3VdbeAddOp3(
                    ...
                    ((*db).dbOptFlags as ::core::ffi::c_uint
                        & 0x800 as ::core::ffi::c_uint != 0 as ::core::ffi::c_uint)
                        as ::core::ffi::c_int,
                );
                sqlite3VdbeAddFunctionCall(
                    pParse,
                ...
                if nColTest > 0 as ::core::ffi::c_int {
                    ...
                    if aGotoChng.is_null() {
                        c2rust_current_block_112 = 11194104282611034094;
                    } else {
                        ...
                        c2rust_current_block_112 = 7330218953828964527;
                    }
                } else {
                    c2rust_current_block_112 = 7330218953828964527;
                }
    ...
    unsafe {
        ...
        if !pIndex.is_null() {
            ...
            if (*pIndex).pPartIdxWhere.is_null() {
                ...
                (*pTable).tabFlags |= TF_HasStat1 as ::core::ffi::c_uint;
            }
        } else {
...
pub unsafe extern "C" fn sqlite3AnalysisLoad(
    ...
    unsafe {
        ...
        while !i.is_null() {
            ...
            (*pTab).tabFlags &= !TF_HasStat1 as ::core::ffi::c_uint;
            i = (*i).next;
        }
