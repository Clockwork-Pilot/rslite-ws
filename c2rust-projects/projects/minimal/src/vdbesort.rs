    ...
    unsafe {
        ...
        if pSorter.is_null() {
            ...
            if sqlite3TempInMemory(db) == 0 {
                ...
                (*pSorter).mnPmaSize = (szPma as ::core::ffi::c_uint)
                    .wrapping_mul(pgsz as ::core::ffi::c_uint) as ::core::ffi::c_int;
...
unsafe extern "C" fn vdbeSorterJoinThread(
    ...
    unsafe {
        ...
        if !(*pTask).pThread.is_null() {
            ...
            rc = pRet as ::core::ffi::c_long as ::core::ffi::c_int;
...
unsafe extern "C" fn vdbeSorterFlushThread(
    ...
    unsafe {
        ...
        return rc as ::core::ffi::c_long as *mut ::core::ffi::c_void;
    }
}
