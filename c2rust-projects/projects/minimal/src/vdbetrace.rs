...
unsafe extern "C" fn findNextHostParameter(
    ...
    unsafe {
        ...
        let mut nTotal: i64_0 = 0 as i64_0;
        let mut n: i64_0 = 0;
        *pnToken = 0 as i64_0;
        while *zSql.offset(0 as ::core::ffi::c_int as isize) != 0 {
            ...
            if tokenType == TK_VARIABLE {
                *pnToken = n;
                ...
                nTotal += n as ::core::ffi::c_longlong;
...
pub unsafe extern "C" fn sqlite3VdbeExpandSql(
    ...
    unsafe {
        ...
        let mut n: i64_0 = 0;
        let mut nToken: i64_0 = 0;
        let mut i: ::core::ffi::c_int = 0;
        let mut pVar: *mut Mem = ::core::ptr::null_mut::<Mem>();
        let mut out: StrAccum = StrAccum {
        ...
        if (*db).nVdbeExec > 1 as ::core::ffi::c_int {
            while *zRawSql != 0 {
                ...
                loop {
                    let c2rust_fresh0 = zRawSql;
                    zRawSql = zRawSql.offset(1);
                    if !(*c2rust_fresh0 as ::core::ffi::c_int != '\n' as i32
                ...
                sqlite3_str_append(
                    &raw mut out,
                    zStart,
                    zRawSql.offset_from(zStart) as ::core::ffi::c_long
                        as ::core::ffi::c_int,
                );
            }
        } else if (*p).nVar as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            sqlite3_str_append(&raw mut out, zRawSql, sqlite3Strlen30(zRawSql));
        } else {
            while *zRawSql.offset(0 as ::core::ffi::c_int as isize) != 0 {
                n = findNextHostParameter(zRawSql, &raw mut nToken);
                sqlite3_str_append(&raw mut out, zRawSql, n as ::core::ffi::c_int);
                zRawSql = zRawSql.offset(n as isize);
                if nToken == 0 as ::core::ffi::c_longlong {
                    break;
                }
                if *zRawSql.offset(0 as ::core::ffi::c_int as isize)
                    as ::core::ffi::c_int == '?' as i32
                {
                    if nToken > 1 as ::core::ffi::c_longlong {
                        sqlite3GetInt32(
                ...
                pVar = (*p).aVar.offset((idx - 1 as ::core::ffi::c_int) as isize)
                    as *mut Mem;
                if (*pVar).flags as ::core::ffi::c_int & MEM_Null != 0 {
                    sqlite3_str_append(
                        &raw mut out,
                        b"NULL\0".as_ptr() as *const ::core::ffi::c_char,
                        4 as ::core::ffi::c_int,
                    );
                } else if (*pVar).flags as ::core::ffi::c_int & (MEM_Int | MEM_IntReal)
                    != 0
                {
                    sqlite3_str_appendf(
                        &raw mut out,
                ...
                } else if (*pVar).flags as ::core::ffi::c_int & MEM_Real != 0 {
                    sqlite3_str_appendf(
                        &raw mut out,
                        b"%!.15g\0".as_ptr() as *const ::core::ffi::c_char,
                        (*pVar).u.r,
                    );
                } else if (*pVar).flags as ::core::ffi::c_int & MEM_Str != 0 {
                    ...
                    if enc as ::core::ffi::c_int != SQLITE_UTF8 {
                        ...
                        if SQLITE_NOMEM
                            == sqlite3VdbeChangeEncoding(&raw mut utf8, SQLITE_UTF8)
                        {
                            out.accError = SQLITE_NOMEM as u8_0;
                            out.nAlloc = 0 as u32_0;
                        }
                        pVar = &raw mut utf8;
                    }
                    nOut = (*pVar).n;
                    ...
                    if enc as ::core::ffi::c_int != SQLITE_UTF8 {
                        sqlite3VdbeMemRelease(&raw mut utf8);
                    }
                } else if (*pVar).flags as ::core::ffi::c_int & MEM_Zero != 0 {
                    sqlite3_str_appendf(
                        &raw mut out,
                        b"zeroblob(%d)\0".as_ptr() as *const ::core::ffi::c_char,
                        (*pVar).u.nZero,
                    );
                } else {
        ...
        if out.accError != 0 {
            sqlite3_str_reset(&raw mut out);
        }
        return sqlite3StrAccumFinish(&raw mut out);
    }
}
