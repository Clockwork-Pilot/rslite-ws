...
pub const PENDING_LOCK: ::core::ffi::c_int = 3 as ::core::ffi::c_int;
                ...
                || (*pInode).eFileLock as ::core::ffi::c_int == RESERVED_LOCK)
        {
                    ...
                    && (*pFile).eFileLock as ::core::ffi::c_int == RESERVED_LOCK
            {
                ...
                if unixFileLock(pFile, &raw mut lock) != 0 {
                    ...
                    c2rust_current_block = 3844232479310898180;
                } else {
        ...
        if (*pFile).eFileLock as ::core::ffi::c_int > SHARED_LOCK {
            if eFileLock == SHARED_LOCK {
                ...
                if unixFileLock(pFile, &raw mut lock) != 0 {
                    ...
                    storeLastErrno(pFile, *__errno_location());
                    c2rust_current_block = 7684165724432296518;
                } else {
            ...
            match c2rust_current_block {
                ...
                _ => {
                    ...
                    if unixFileLock(pFile, &raw mut lock) == 0 as ::core::ffi::c_int {
                        ...
                        c2rust_current_block = 13472856163611868459;
                    } else {
                        rc = SQLITE_IOERR_UNLOCK;
                        storeLastErrno(pFile, *__errno_location());
                        c2rust_current_block = 7684165724432296518;
...
unsafe extern "C" fn dotlockLock(
    ...
    unsafe {
        ...
        if (*pFile).eFileLock as ::core::ffi::c_int > NO_LOCK {
            (*pFile).eFileLock = eFileLock as ::core::ffi::c_uchar;
            utimes(zLockFile, ::core::ptr::null::<timeval>());
            return SQLITE_OK;
        }
        rc = ::core::mem::transmute::<
            sqlite3_syscall_ptr,
    ...
    unsafe {
        ...
        loop {
            got = ::core::mem::transmute::<
                ...
                >,
            >(aSyscall[9 as ::core::ffi::c_int as usize].pCurrent)
                .expect(
                    "non-null function pointer",
                )((*id).h, pBuf, cnt as size_t, offset as off_t) as ::core::ffi::c_int;
            if got == cnt {
                break;
            }
    ...
    unsafe {
        ...
        loop {
            rc = ::core::mem::transmute::<
                ...
                >,
            >(aSyscall[12 as ::core::ffi::c_int as usize].pCurrent)
                .expect(
                    "non-null function pointer",
                )(fd, pBuf, nBuf as size_t, iOff as off_t) as ::core::ffi::c_int;
            if !(rc < 0 as ::core::ffi::c_int && *__errno_location() == EINTR) {
                break;
            }
        }
    ...
    unsafe {
        ...
        match op {
            ...
            SQLITE_FCNTL_VFSNAME => {
                let ref mut c2rust_fresh5 = *(pArg as *mut *mut ::core::ffi::c_char);
            ...
            SQLITE_FCNTL_TEMPFILENAME => {
                ...
                if !zTFile.is_null() {
                    ...
                    let ref mut c2rust_fresh6 = *(pArg as *mut *mut ::core::ffi::c_char);
                    *c2rust_fresh6 = zTFile;
                }
                return SQLITE_OK;
            }
    ...
    unsafe {
        ...
        if pShmNode.is_null() {
                ...
                .expect("non-null function pointer")((*pDbFd).h, &raw mut sStat) != 0
            {
                ...
                c2rust_current_block = 12703345375805582042;
            } else {
...
unsafe extern "C" fn unixShmMap(
    ...
    unsafe {
        ...
        if (*pShmNode).isUnlocked != 0 {
            ...
            if rc != SQLITE_OK {
                c2rust_current_block = 10966260538959451938;
            } else {
                        ...
                        _ => {
                            ...
                            if apNew.is_null() {
                                    ...
                                    < nReqRegion
                                {
                                    ...
                                    i = 0 as ::core::ffi::c_int;
                                    while i < nShmPerMap {
                                        let ref mut c2rust_fresh9 = *(*pShmNode)
                                            .apRegion
                                            .offset(
                                                ((*pShmNode).nRegion as ::core::ffi::c_int + i) as isize,
                                            );
                                        *c2rust_fresh9 = (pMem as *mut ::core::ffi::c_char)
                ...
                if flags & SQLITE_SHM_UNLOCK != 0 {
                    ...
                    if flags & SQLITE_SHM_SHARED != 0 {
                        if *aLock.offset(ofst as isize) > 1 as ::core::ffi::c_int {
                            ...
                            let ref mut c2rust_fresh3 = *aLock.offset(ofst as isize);
                            *c2rust_fresh3 -= 1;
                    ...
                    if rc == SQLITE_OK {
                        (*p).sharedMask = ((*p).sharedMask as ::core::ffi::c_int
                            | mask as ::core::ffi::c_int) as u16_0;
                        let ref mut c2rust_fresh4 = *aLock.offset(ofst as isize);
                        *c2rust_fresh4 += 1;
                    }
                } else {
                    let mut ii: ::core::ffi::c_int = 0;
...
unsafe extern "C" fn unixTempFileDir() -> *const ::core::ffi::c_char {
    unsafe {
        ...
        loop {
            ...
            let c2rust_fresh8 = i;
            i = i.wrapping_add(1);
            zDir = azTempDirs[c2rust_fresh8 as usize];
        }
        return ::core::ptr::null::<::core::ffi::c_char>();
    }
}
            ...
            loop {
                ...
                *zBuf.offset((nBuf - 2 as ::core::ffi::c_int) as isize) = 0
                ...
                if *zBuf.offset((nBuf - 2 as ::core::ffi::c_int) as isize)
                    ...
                    || {
                        let c2rust_fresh7 = iLimit;
                        iLimit = iLimit + 1;
                        c2rust_fresh7 > 10 as ::core::ffi::c_int
                    }
                {
                    rc = SQLITE_ERROR;
                    break;
    ...
    unsafe {
        ...
        if fd < 0 as ::core::ffi::c_int {
            ...
            if fd < 0 as ::core::ffi::c_int {
                ...
                c2rust_current_block = 16259877080646838762;
            } else {
                if openMode != 0
                ...
                c2rust_current_block = 13660591889533726445;
            }
        } else {
            c2rust_current_block = 13660591889533726445;
        }
...
pub const unixDlOpen: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
pub const unixDlError: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
pub const unixDlSym: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
pub const unixDlClose: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
unsafe extern "C" fn unixRandomness(
    ...
    unsafe {
        ...
        if fd < 0 as ::core::ffi::c_int {
            ...
            memcpy(
                zBuf.offset(::core::mem::size_of::<time_t>() as isize)
                    as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
                &raw mut randomnessPid as *const ::core::ffi::c_void,
                ::core::mem::size_of::<pid_t>() as size_t,
            );
            nBuf = (::core::mem::size_of::<time_t>() as usize)
                .wrapping_add(::core::mem::size_of::<pid_t>() as usize)
                as ::core::ffi::c_int;
        } else {
            loop {
                got = ::core::mem::transmute::<
                    ...
                    >,
                >(aSyscall[8 as ::core::ffi::c_int as usize].pCurrent)
                    .expect(
                        "non-null function pointer",
                    )(fd, zBuf as *mut ::core::ffi::c_void, nBuf as size_t)
                    as ::core::ffi::c_int;
                if !(got < 0 as ::core::ffi::c_int && *__errno_location() == EINTR) {
                    break;
                }
            }
            robust_close(
...
pub const unixCurrentTime: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
