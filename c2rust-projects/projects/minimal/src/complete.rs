        ...
        while *zSql != 0 {
            ...
            match *zSql as ::core::ffi::c_int {
                59 => {
                    ...
                    c2rust_current_block_65 = 10512632378975961025;
                }
                32 | 13 | 9 | 10 | 12 => {
                    token = tkWS as u8_0;
                    c2rust_current_block_65 = 10512632378975961025;
                ...
                47 => {
                    if *zSql.offset(1 as ::core::ffi::c_int as isize)
                        as ::core::ffi::c_int != '*' as i32
                    {
                        token = tkOTHER as u8_0;
                    } else {
                        zSql = zSql.offset(2 as ::core::ffi::c_int as isize);
                        while *zSql.offset(0 as ::core::ffi::c_int as isize)
                            as ::core::ffi::c_int != 0
                            && (*zSql.offset(0 as ::core::ffi::c_int as isize)
                                as ::core::ffi::c_int != '*' as i32
                                || *zSql.offset(1 as ::core::ffi::c_int as isize)
                                    as ::core::ffi::c_int != '/' as i32)
                        {
                            zSql = zSql.offset(1);
                        }
                        if *zSql.offset(0 as ::core::ffi::c_int as isize)
                ...
                45 => {
                        ...
                        as ::core::ffi::c_int != '-' as i32
                    {
                        ...
                        if *zSql as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                            return (state as ::core::ffi::c_int
                ...
                96 => {
                    c2rust_current_block_65 = 4775909272756257391;
                }
                34 | 39 => {
                    c2rust_current_block_65 = 4775909272756257391;
                }
                _ => {
                    if *(&raw const sqlite3CtypeMap as *const ::core::ffi::c_uchar)
                        .offset(*zSql as u8_0 as isize) as ::core::ffi::c_int
                        & 0x46 as ::core::ffi::c_int != 0 as ::core::ffi::c_int
                    {
                        ...
                        while *(&raw const sqlite3CtypeMap
                            ...
                            .offset(
                                *zSql.offset(nId as isize) as ::core::ffi::c_uchar as isize,
                        ...
                        match *zSql as ::core::ffi::c_int {
                            ...
                            116 | 84 => {
                                    ...
                                    ) == 0 as ::core::ffi::c_int
                                {
                                    ...
                                    && sqlite3_strnicmp(
                                        zSql,
                                        b"temporary\0".as_ptr() as *const ::core::ffi::c_char,
                                        9 as ::core::ffi::c_int,
                                    ) == 0 as ::core::ffi::c_int
                                {
                                    token = tkTEMP as u8_0;
...
pub unsafe extern "C" fn sqlite3_complete16(
    ...
    unsafe {
        ...
        let mut zSql8: *const ::core::ffi::c_char = ::core::ptr::null::<
            ::core::ffi::c_char,
        >();
        ...
        zSql8 = sqlite3ValueText(pVal, SQLITE_UTF8 as u8_0)
