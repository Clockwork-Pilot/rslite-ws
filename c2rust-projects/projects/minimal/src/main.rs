...
>; 1] = unsafe {
    [
        Some(
            sqlite3TestExtInit
                as unsafe extern "C" fn(*mut sqlite3) -> ::core::ffi::c_int,
        ),
    ]
};
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3RollbackAll(
    ...
    unsafe {
        ...
        sqlite3BeginBenignMalloc();
        schemaChange = ((*db).mDbFlags as ::core::ffi::c_uint
            & DBFLAG_SchemaChange as ::core::ffi::c_uint != 0 as ::core::ffi::c_uint
    ...
    unsafe {
        ...
        if !p.is_null()
            && (*p).funcFlags as ::core::ffi::c_uint
                & SQLITE_FUNC_ENCMASK as ::core::ffi::c_uint == enc as u32_0
        ...
        (*p).funcFlags = ((*p).funcFlags as ::core::ffi::c_uint
            & SQLITE_FUNC_ENCMASK as ::core::ffi::c_uint
            | extraFlags as ::core::ffi::c_uint) as u32_0;
    ...
    unsafe {
        ...
        if xDestroy.is_some() {
            ...
            if pArg.is_null() {
                ...
                c2rust_current_block = 9289820379484129175;
            } else {
...
pub unsafe extern "C" fn sqlite3WalDefaultHook(
    ...
    unsafe {
        if nFrame >= pClientData as ::core::ffi::c_long as ::core::ffi::c_int {
            sqlite3BeginBenignMalloc();
    ...
    unsafe {
        if nFrame > 0 as ::core::ffi::c_int {
            sqlite3_wal_hook(
                ...
                nFrame as ::core::ffi::c_long as *mut ::core::ffi::c_void,
            );
        } else {
                    ...
                    == '/' as i32
            {
                        ...
                        ) != 0)
                {
                    *pzErrMsg = sqlite3_mprintf(
                    ...
                    rc = SQLITE_ERROR;
                    c2rust_current_block = 7882177134942819890;
                } else {
        ...
        if !db.is_null() {
            if isThreadsafe != 0 {
                ...
                if (*db).mutex.is_null() {
                    ...
                    c2rust_current_block = 7414280715149895429;
                } else {
                    isThreadsafe == 0 as ::core::ffi::c_int;
                                ...
                                if !((*db).mallocFailed != 0) {
                                                ...
                                                ) as ::core::ffi::c_int
                                    {
                                        rc = sqlite3BuiltinExtensions[i as usize]
                                            .expect("non-null function pointer")(db);
                                        i += 1;
                                    }
                                    if rc == SQLITE_OK {
                                        ...
                                        if rc != SQLITE_OK {
                                            ...
                                            c2rust_current_block = 16108440464692313034;
                                        }
                                    } else {
                                        c2rust_current_block = 16108440464692313034;
                                    }
            ...
            if pTab.is_null() || (*pTab).eTabType as ::core::ffi::c_int == TABTYP_VIEW {
                ...
                if zColumnName.is_null() {
                    ...
                    if iCol >= 0 as ::core::ffi::c_int {
                        ...
                        == 0 as ::core::ffi::c_uint && sqlite3IsRowid(zColumnName) != 0
                    {
                        ...
                        if !pCol.is_null() {
                            ...
                            autoinc = ((*pTab).iPKey as ::core::ffi::c_int == iCol
                                && (*pTab).tabFlags as ::core::ffi::c_uint
                                    & TF_Autoincrement as ::core::ffi::c_uint
    ...
    unsafe {
        ...
        match op {
            ...
            SQLITE_TESTCTRL_INTERNAL_FUNCTIONS => {
                ...
                (*db_3).mDbFlags ^= DBFLAG_InternalFunc as ::core::ffi::c_uint;
            }
            ...
            SQLITE_TESTCTRL_IMPOSTER => {
                ...
                if iDb >= 0 as ::core::ffi::c_int {
                    ...
                    if (*db_5).init.busy as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                        && (*db_5).init.newTnum > 0 as ::core::ffi::c_uint
                    {
