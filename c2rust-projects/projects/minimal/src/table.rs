...
unsafe extern "C" fn sqlite3_get_table_cb(
    ...
    unsafe {
        ...
        let mut z: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
            ::core::ffi::c_char,
        >();
        if (*p).nRow == 0 as ::core::ffi::c_uint && !argv.is_null() {
            need = nCol * 2 as ::core::ffi::c_int;
        } else {
            need = nCol;
        }
        if ((*p).nData as ::core::ffi::c_uint).wrapping_add(need as ::core::ffi::c_uint)
            > (*p).nAlloc
        {
            let mut azNew: *mut *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
                *mut ::core::ffi::c_char,
            >();
            (*p).nAlloc = ((*p).nAlloc as ::core::ffi::c_uint)
                .wrapping_mul(2 as ::core::ffi::c_uint)
                .wrapping_add(need as ::core::ffi::c_uint) as u32_0;
            azNew = sqlite3Realloc(
                (*p).azResult as *mut ::core::ffi::c_void,
                (::core::mem::size_of::<*mut ::core::ffi::c_char>() as usize)
                    .wrapping_mul((*p).nAlloc as usize) as u64_0,
            ) as *mut *mut ::core::ffi::c_char;
            if azNew.is_null() {
                c2rust_current_block = 9552616142031122011;
            } else {
                (*p).azResult = azNew;
        ...
        match c2rust_current_block {
            11812396948646013369 => {
                if (*p).nRow == 0 as ::core::ffi::c_uint {
                    (*p).nColumn = nCol as u32_0;
                        ...
                        if !argv.is_null() {
                            ...
                            loop {
                                ...
                                if (*argv.offset(i as isize)).is_null() {
                                    ...
                                    z = sqlite3_malloc64(n as sqlite3_uint64)
                                ...
                                let c2rust_fresh4 = (*p).nData;
                                (*p).nData = (*p).nData.wrapping_add(1);
                                let ref mut c2rust_fresh5 = *(*p)
                                    .azResult
                            ...
                            match c2rust_current_block {
                                ...
                                _ => {
                                    ...
                                    c2rust_current_block = 15897653523371991391;
                                }
                            }
                        } else {
                            c2rust_current_block = 15897653523371991391;
...
pub unsafe extern "C" fn sqlite3_get_table(
    ...
    unsafe {
        ...
        *pazResult = ::core::ptr::null_mut::<*mut ::core::ffi::c_char>();
        ...
        res.nRow = 0 as u32_0;
        res.nColumn = 0 as u32_0;
        res.nData = 1 as u32_0;
        res.nAlloc = 20 as u32_0;
        res.rc = SQLITE_OK;
        res.azResult = sqlite3_malloc64(
            (::core::mem::size_of::<*mut ::core::ffi::c_char>() as usize)
                .wrapping_mul(res.nAlloc as usize) as sqlite3_uint64,
        ) as *mut *mut ::core::ffi::c_char;
        if res.azResult.is_null() {
            (*db).errCode = SQLITE_NOMEM;
            return SQLITE_NOMEM_BKPT;
        }
        let ref mut c2rust_fresh0 = *res
            .azResult
        ...
        *c2rust_fresh0 = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        let ref mut c2rust_fresh1 = *res
            .azResult
            .offset(0 as ::core::ffi::c_int as isize);
        *c2rust_fresh1 = res.nData as ::core::ffi::c_long as *mut ::core::ffi::c_void
            as *mut ::core::ffi::c_char;
        if rc & 0xff as ::core::ffi::c_int == SQLITE_ABORT {
            sqlite3_free_table(
                res.azResult.offset(1 as ::core::ffi::c_int as isize)
                    as *mut *mut ::core::ffi::c_char,
            );
            if !res.zErrMsg.is_null() {
                if !pzErrMsg.is_null() {
                    sqlite3_free(*pzErrMsg as *mut ::core::ffi::c_void);
                    *pzErrMsg = sqlite3_mprintf(
                        b"%s\0".as_ptr() as *const ::core::ffi::c_char,
                        res.zErrMsg,
                    );
                }
                sqlite3_free(res.zErrMsg as *mut ::core::ffi::c_void);
            }
            (*db).errCode = res.rc;
            return res.rc;
        }
        ...
        if res.nAlloc > res.nData {
            ...
            azNew = sqlite3Realloc(
                ...
                (::core::mem::size_of::<*mut ::core::ffi::c_char>() as usize)
                    .wrapping_mul(res.nData as usize) as u64_0,
            ) as *mut *mut ::core::ffi::c_char;
            if azNew.is_null() {
                sqlite3_free_table(
                    res.azResult.offset(1 as ::core::ffi::c_int as isize)
        ...
        *pazResult = res.azResult.offset(1 as ::core::ffi::c_int as isize)
            as *mut *mut ::core::ffi::c_char;
        if !pnColumn.is_null() {
...
pub unsafe extern "C" fn sqlite3_free_table(
    mut azResult: *mut *mut ::core::ffi::c_char,
) {
    unsafe {
        if !azResult.is_null() {
            let mut i: ::core::ffi::c_int = 0;
            ...
            n = *azResult.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_long
                as ::core::ffi::c_int;
            ...
            sqlite3_free(azResult as *mut ::core::ffi::c_void);
        }
    }
}
