...
#[no_mangle]
pub unsafe extern "C" fn sqlite3_release_memory(
...
pub unsafe extern "C" fn sqlite3_soft_heap_limit64(
    ...
    unsafe {
        ...
        if mem0.hardLimit > 0 as ::core::ffi::c_longlong
            && (n > mem0.hardLimit || n == 0 as ::core::ffi::c_longlong)
        {
            n = mem0.hardLimit;
        }
        ...
        if excess > 0 as ::core::ffi::c_longlong {
            sqlite3_release_memory(
                (excess as ::core::ffi::c_longlong
    ...
    unsafe {
        ...
        if n >= 0 as ::core::ffi::c_longlong {
            ...
            if n < mem0.alarmThreshold
                || mem0.alarmThreshold == 0 as ::core::ffi::c_longlong
            {
                mem0.alarmThreshold = n;
            }
        }
...
unsafe extern "C" fn sqlite3MallocAlarm(mut nByte: ::core::ffi::c_int) {
    unsafe {
        if mem0.alarmThreshold <= 0 as ::core::ffi::c_longlong {
            return;
        }
        sqlite3_mutex_leave(mem0.mutex);
...
unsafe extern "C" fn mallocWithAlarm(
    ...
    unsafe {
        ...
        if mem0.alarmThreshold > 0 as ::core::ffi::c_longlong {
            ...
            if nUsed
                >= mem0.alarmThreshold as ::core::ffi::c_longlong
                    - nFull as ::core::ffi::c_longlong
            {
                ;
                ...
                if mem0.hardLimit != 0 {
                    nUsed = sqlite3StatusValue(SQLITE_STATUS_MEMORY_USED);
                    if nUsed
                        >= mem0.hardLimit as ::core::ffi::c_longlong
                            - nFull as ::core::ffi::c_longlong
                    {
...
pub const SQLITE_MAX_ALLOCATION_SIZE: ::core::ffi::c_int = 2147483391
    as ::core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn sqlite3Malloc(mut n: u64_0) -> *mut ::core::ffi::c_void {
    unsafe {
        let mut p: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
            ::core::ffi::c_void,
        >();
        if n == 0 as ::core::ffi::c_ulonglong
            || n > SQLITE_MAX_ALLOCATION_SIZE as ::core::ffi::c_ulonglong
        {
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3_malloc(
    mut n: ::core::ffi::c_int,
) -> *mut ::core::ffi::c_void {
    unsafe {
...
pub unsafe extern "C" fn sqlite3Realloc(
    ...
    unsafe {
        ...
        let mut pNew: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
            ::core::ffi::c_void,
        >();
        if pOld.is_null() {
            return sqlite3Malloc(nBytes);
        }
        if nBytes == 0 as ::core::ffi::c_ulonglong {
            sqlite3_free(pOld);
            return ::core::ptr::null_mut::<::core::ffi::c_void>();
        }
        if nBytes >= 0x7fffff00 as ::core::ffi::c_ulonglong {
            return ::core::ptr::null_mut::<::core::ffi::c_void>();
        }
...
pub unsafe extern "C" fn sqlite3DbMallocRawNN(
    ...
    unsafe {
        ...
        if n > (*db).lookaside.sz as ::core::ffi::c_ulonglong {
            if (*db).lookaside.bDisable == 0 {
                (*db).lookaside.anStat[1 as ::core::ffi::c_int as usize] = (*db)
                    .lookaside
                    .anStat[1 as ::core::ffi::c_int as usize]
                    .wrapping_add(1);
        ...
        if n <= LOOKASIDE_SMALL as ::core::ffi::c_ulonglong {
            pBuf = (*db).lookaside.pSmallFree;
            if !pBuf.is_null() {
                (*db).lookaside.pSmallFree = (*pBuf).pNext;
                (*db).lookaside.anStat[0 as ::core::ffi::c_int as usize] = (*db)
                    .lookaside
                    .anStat[0 as ::core::ffi::c_int as usize]
                    .wrapping_add(1);
        ...
        if !pBuf.is_null() {
            ...
            if !pBuf.is_null() {
                ...
                (*db).lookaside.anStat[2 as ::core::ffi::c_int as usize] = (*db)
                    .lookaside
                    .anStat[2 as ::core::ffi::c_int as usize]
                    .wrapping_add(1);
            }
        }
        return dbMallocRawFinish(db, n);
    ...
    unsafe {
        ...
        if (p as uptr) < (*db).lookaside.pEnd as uptr {
            if p as uptr >= (*db).lookaside.pMiddle as uptr {
                ...
                if n <= (*db).lookaside.szTrue as ::core::ffi::c_ulonglong {
                    return p;
                }
            }
        }
...
pub unsafe extern "C" fn sqlite3DbStrDup(
    ...
    unsafe {
        ...
        if !zNew.is_null() {
            memcpy(zNew as *mut ::core::ffi::c_void, z as *const ::core::ffi::c_void, n);
        }
        return zNew;
    }
}
...
pub unsafe extern "C" fn sqlite3DbSpanDup(
    ...
    unsafe {
        ...
        while *(&raw const sqlite3CtypeMap as *const ::core::ffi::c_uchar)
            .offset(
                *zStart.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_uchar
                    as isize,
        ...
        while *(&raw const sqlite3CtypeMap as *const ::core::ffi::c_uchar)
            .offset(
                *zStart.offset((n - 1 as ::core::ffi::c_int) as isize)
