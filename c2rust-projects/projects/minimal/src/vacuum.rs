            ...
            if !((*pParse).nErr != 0) {
                if !pNm.is_null() {
                    ...
                    if iDb < 0 as ::core::ffi::c_int {
                        c2rust_current_block = 6136375772093062618;
                    } else {
...
pub unsafe extern "C" fn sqlite3RunVacuum(
    ...
    unsafe {
        ...
        (*db).mDbFlags |= (DBFLAG_PreferBuiltin | DBFLAG_Vacuum) as ::core::ffi::c_uint;
        (*db).flags
        ...
        if !(rc != SQLITE_OK) {
            ...
            if !pOut.is_null() {
                        ...
                        || sz > 0 as ::core::ffi::c_longlong)
                {
                    ...
                    c2rust_current_block = 7235586815983067526;
                } else {
                    (*db).mDbFlags |= DBFLAG_VacuumInto as ::core::ffi::c_uint;
                                    ...
                                    ) != 0 || (*db).mallocFailed as ::core::ffi::c_int != 0
                            {
                                ...
                                if !(rc != SQLITE_OK) {
                                    ...
                                    if !(rc != SQLITE_OK) {
                                        ...
                                        (*db).mDbFlags &= !DBFLAG_Vacuum as ::core::ffi::c_uint;
                                        if !(rc != SQLITE_OK) {
                                            rc = execSqlF(
                                                db,
                                                pzErrMsg,
