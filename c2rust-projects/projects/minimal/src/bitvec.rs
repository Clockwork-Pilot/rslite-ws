...
pub unsafe extern "C" fn sqlite3BitvecTestNotNull(
    ...
    unsafe {
        ...
        if (*p).iSize as usize <= BITVEC_NBIT {
            return ((*p)
                .u
                .aBitmap[(i as ::core::ffi::c_uint)
                .wrapping_div(BITVEC_SZELEM as ::core::ffi::c_uint) as usize]
                as ::core::ffi::c_int
                & (1 as ::core::ffi::c_int)
            ...
            let c2rust_fresh0 = i;
            i = i.wrapping_add(1);
            let mut h: u32_0 = (c2rust_fresh0.wrapping_mul(1 as ::core::ffi::c_uint)
                as usize)
            ...
            while (*p).u.aHash[h as usize] != 0 {
                ...
                h = ((h as ::core::ffi::c_uint).wrapping_add(1 as ::core::ffi::c_uint)
                    as usize)
                    .wrapping_rem(BITVEC_NINT) as u32_0;
            }
            return 0 as ::core::ffi::c_int;
    ...
    unsafe {
        ...
        if (*p).iSize as usize <= BITVEC_NBIT {
            (*p)
                .u
                .aBitmap[(i as ::core::ffi::c_uint)
                .wrapping_div(BITVEC_SZELEM as ::core::ffi::c_uint) as usize] = ((*p)
                .u
                .aBitmap[(i as ::core::ffi::c_uint)
                .wrapping_div(BITVEC_SZELEM as ::core::ffi::c_uint) as usize]
                as ::core::ffi::c_int
        ...
        let c2rust_fresh1 = i;
        i = i.wrapping_add(1);
        h = (c2rust_fresh1.wrapping_mul(1 as ::core::ffi::c_uint) as usize)
            .wrapping_rem(BITVEC_NINT) as u32_0;
        if (*p).u.aHash[h as usize] == 0 {
            if ((*p).nSet as usize) < BITVEC_NINT.wrapping_sub(1 as usize) {
                c2rust_current_block = 3235438861129813371;
            } else {
                c2rust_current_block = 12805241000073955660;
            }
        } else {
            loop {
                if (*p).u.aHash[h as usize] == i {
            ...
            12805241000073955660 => {
                if (*p).nSet as usize >= BITVEC_MXHASH {
                    ...
                    if aiValues.is_null() {
                        ...
                        if (*p).iSize.wrapping_rem(BITVEC_NPTR)
        ...
        if (*p).iSize as usize <= BITVEC_NBIT {
            (*p)
                ...
                & !(((1 as ::core::ffi::c_int)
                    << (i as ::core::ffi::c_uint
                        & (BITVEC_SZELEM - 1 as ::core::ffi::c_int)
                            as ::core::ffi::c_uint)) as u8_0 as ::core::ffi::c_int))
                as u8_0;
        } else {
            let mut j: ::core::ffi::c_uint = 0;
            ...
            while (j as usize) < BITVEC_NINT {
                            ...
                            .wrapping_add(1 as ::core::ffi::c_uint)
                {
                    let mut h: u32_0 = ((*aiValues.offset(j as isize)
                        ...
                        .wrapping_mul(1 as ::core::ffi::c_uint) as usize)
                        .wrapping_rem(BITVEC_NINT) as u32_0;
                    (*p).nSet = (*p).nSet.wrapping_add(1);
                    while (*p).u.aHash[h as usize] != 0 {
                        h = h.wrapping_add(1);
                ...
                if op >= 6 as ::core::ffi::c_int {
                    ...
                    *c2rust_fresh2 -= 1;
                    ...
                    if op & 1 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                        ...
                        {
                            c2rust_current_block = 5667170309418625258;
                            break;
                        }
                    } else {
                        if !pV.is_null() {
                ...
                _ => {
                    if !pV.is_null() {
                        rc = ((sqlite3BitvecTest(
                            ...
                            ) + sqlite3BitvecTest(pBitvec, 0 as u32_0))
                            as ::core::ffi::c_uint)
                            .wrapping_add(
                                (sqlite3BitvecSize(pBitvec) as ::core::ffi::c_uint)
                                    .wrapping_sub(sz as ::core::ffi::c_uint),
                            ) as ::core::ffi::c_int;
