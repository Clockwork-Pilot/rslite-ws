...
pub unsafe extern "C" fn sqlite3AppendOneUtf8Character(
    ...
    unsafe {
        if v < 0x80 as ::core::ffi::c_uint {
            *zOut.offset(0 as ::core::ffi::c_int as isize) = (v as ::core::ffi::c_uint
                & 0xff as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_char;
            return 1 as ::core::ffi::c_int;
        }
        if v < 0x800 as ::core::ffi::c_uint {
            *zOut.offset(0 as ::core::ffi::c_int as isize) = (0xc0 as ::core::ffi::c_int
                + (v as ::core::ffi::c_uint >> 6 as ::core::ffi::c_int
                    & 0x1f as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_int)
                as ::core::ffi::c_char;
            *zOut.offset(1 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
                + (v as ::core::ffi::c_uint & 0x3f as ::core::ffi::c_uint) as u8_0
                    as ::core::ffi::c_int) as ::core::ffi::c_char;
            return 2 as ::core::ffi::c_int;
        }
        if v < 0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint {
            ...
            *zOut.offset(1 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
                + (v as ::core::ffi::c_uint >> 6 as ::core::ffi::c_int
                    & 0x3f as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_int)
                as ::core::ffi::c_char;
        ...
        *zOut.offset(0 as ::core::ffi::c_int as isize) = (0xf0 as ::core::ffi::c_int
            + (v as ::core::ffi::c_uint >> 18 as ::core::ffi::c_int
...
pub unsafe extern "C" fn sqlite3Utf8ReadLimited(
    ...
    unsafe {
        ...
        if c >= 0xc0 as ::core::ffi::c_uint {
            c = sqlite3Utf8Trans1[(c as ::core::ffi::c_uint)
                .wrapping_sub(0xc0 as ::core::ffi::c_uint) as usize] as u32_0;
            ...
            {
                c = ((c as ::core::ffi::c_uint) << 6 as ::core::ffi::c_int)
                    .wrapping_add(
                        (0x3f as ::core::ffi::c_int
                            & *z.offset(i as isize) as ::core::ffi::c_int)
                            as ::core::ffi::c_uint,
