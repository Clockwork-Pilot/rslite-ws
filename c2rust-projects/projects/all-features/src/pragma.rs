...
unsafe extern "C" fn tableSkipIntegrityCheck(
    ...
    unsafe {
        if !pObjTab.is_null() {
            ...
            return ((*pTab).tabFlags & TF_Imposter as u32_0 != 0 as u32_0)
                as ::core::ffi::c_int
        };
    }
}
                ...
                if !pPragma.is_null() {
                        ...
                        != 0 as ::core::ffi::c_int
                    {
                        if sqlite3ReadSchema(pParse) != 0 {
                            c2rust_current_block = 16304003877529886656;
                        } else {
                            ...
                            match (*pPragma).ePragTyp as ::core::ffi::c_int {
                                PragTyp_DEFAULT_CACHE_SIZE => {
                                    ...
                                    if zRight.is_null() {
                                        ...
                                        (*aOp.offset(6 as ::core::ffi::c_int as isize)).p1 = SQLITE_DEFAULT_CACHE_SIZE;
                                    } else {
                                        let mut size: ::core::ffi::c_int = sqlite3AbsInt32(
                                            sqlite3Atoi(zRight),
                                        );
                                    ...
                                    c2rust_current_block = 17607975748632905087;
                                }
                                PragTyp_PAGE_SIZE => {
                                ...
                                PragTyp_AUTO_VACUUM => {
                                    ...
                                    if zRight.is_null() {
                                                ...
                                                || eAuto == 2 as ::core::ffi::c_int)
                                        {
                                            ...
                                            (*aOp_0.offset(2 as ::core::ffi::c_int as isize)).p2 = iAddr
                                                + 4 as ::core::ffi::c_int;
                                            (*aOp_0.offset(4 as ::core::ffi::c_int as isize)).p1 = iDb;
                                            (*aOp_0.offset(4 as ::core::ffi::c_int as isize)).p3 = eAuto
                                                - 1 as ::core::ffi::c_int;
                                            sqlite3VdbeUsesBtree(v, iDb);
                                        }
                                    }
                                ...
                                PragTyp_CACHE_SPILL => {
                                    if zRight.is_null() {
                                        ...
                                        let mut size_2: ::core::ffi::c_int = 1
                                            as ::core::ffi::c_int;
                                ...
                                PragTyp_TEMP_STORE_DIRECTORY => {
                                    ...
                                    if zRight.is_null() {
                                        ...
                                        c2rust_current_block = 6678684093116635837;
                                    } else {
                                        if *zRight.offset(0 as ::core::ffi::c_int as isize) != 0 {
                                            ...
                                            if rc != SQLITE_OK || res == 0 as ::core::ffi::c_int {
                                                ...
                                                c2rust_current_block = 4497948414247713119;
                                            }
                                        } else {
                                            c2rust_current_block = 4497948414247713119;
                                        }
                                ...
                                PragTyp_TABLE_INFO => {
                                    if !zRight.is_null() {
                                        ...
                                        if !pTab.is_null() {
                                            ...
                                            let mut c2rust_current_block_303: u64;
                                            i = 0 as ::core::ffi::c_int;
                                            pCol = (*pTab).aCol;
                                            while i < (*pTab).nCol as ::core::ffi::c_int {
                                                    ...
                                                    != 0
                                                {
                                                    if (*pPragma).iArg == 0 as ::core::ffi::c_ulonglong {
                                                        nHidden += 1;
                                                        c2rust_current_block_303 = 10453323034968249808;
                                                    } else {
                                                        ...
                                                        c2rust_current_block_303 = 4839309778395429725;
                                                    }
                                                } else {
                                                    c2rust_current_block_303 = 4839309778395429725;
                                                }
                                                match c2rust_current_block_303 {
                                                    4839309778395429725 => {
                                            ...
                                            ) != 0 as ::core::ffi::c_int)
                                        {
                                            ...
                                            while !k_0.is_null() {
                                                        ...
                                                        != 0 as ::core::ffi::c_int)
                                                {
                                                    ...
                                                    } else if (*pTab_1).tabFlags & TF_Shadow as u32_0 != 0 {
                                                    ...
                                                    sqlite3VdbeMultiLoad(
                                                        ...
                                                        ((*pTab_1).tabFlags & TF_Strict as u32_0 != 0 as u32_0)
                                                            as ::core::ffi::c_int,
                                                    );
                                                }
                                                k_0 = (*k_0).next;
                                ...
                                PragTyp_FUNCTION_LIST => {
                                    ...
                                    let mut showInternFunc: ::core::ffi::c_int = ((*db).mDbFlags
                                        & DBFLAG_InternalFunc as u32_0 != 0 as u32_0)
                                        as ::core::ffi::c_int;
                                    (*pParse).nMem = 6 as ::core::ffi::c_int;
                                ...
                                PragTyp_INTEGRITY_CHECK => {
                                                ...
                                                if !(cnt == 0 as ::core::ffi::c_int) {
                                                    ...
                                                    while !x_1.is_null() {
                                                        ...
                                                        if !(tableSkipIntegrityCheck(pTab_7, pObjTab) != 0) {
                                                            if (*pTab_7).tabFlags & TF_WithoutRowid as u32_0
                                                                == 0 as u32_0
                                                            {
                                                                cnt += 1;
                                                    ...
                                                    *aRoot.offset(0 as ::core::ffi::c_int as isize) = cnt;
                                                    ...
                                                    while !x_1.is_null() {
                                                        ...
                                                        if !(tableSkipIntegrityCheck(pTab_8, pObjTab) != 0) {
                                                            if (*pTab_8).tabFlags & TF_WithoutRowid as u32_0
                                                                == 0 as u32_0
                                                            {
                                                    ...
                                                    while !x_1.is_null() {
                                                        ...
                                                        if !(tableSkipIntegrityCheck(pTab_9, pObjTab) != 0) {
                                                            if (*pTab_9).eTabType as ::core::ffi::c_int == TABTYP_NORM {
                                                                if isQuick != 0
                                                                    || (*pTab_9).tabFlags & TF_WithoutRowid as u32_0
                                                                        == 0 as u32_0
                                                                {
                                                                ...
                                                                if (*pTab_9).tabFlags & TF_WithoutRowid as u32_0
                                                                    == 0 as u32_0
                                                                {
                                                                ...
                                                                bStrict = ((*pTab_9).tabFlags & TF_Strict as u32_0
                                                                    != 0 as u32_0) as ::core::ffi::c_int;
                                                                j_3 = 0 as ::core::ffi::c_int;
                                                                while j_3 < (*pTab_9).nCol as ::core::ffi::c_int {
                                                    ...
                                                    let mut c2rust_current_block_842: u64;
                                                    x_1 = (*pTbls).first;
                                                    while !x_1.is_null() {
                                                                ...
                                                                if (*pTab_10).eTabType as ::core::ffi::c_int == TABTYP_VTAB
                                                                {
                                                                        ...
                                                                        <= 0 as ::core::ffi::c_int
                                                                    {
                                                                        ...
                                                                        if sqlite3HashFind(&raw mut (*db).aModule, zMod).is_null() {
                                                                            c2rust_current_block_842 = 17618370480342365186;
                                                                        } else {
                                                                            c2rust_current_block_842 = 10746975261342658336;
                                                                        }
                                                                    } else {
                                                                        c2rust_current_block_842 = 10746975261342658336;
                                                                    }
                                                                    match c2rust_current_block_842 {
                                    ...
                                    static mut iLn_1: ::core::ffi::c_int = 0
                                        as ::core::ffi::c_int;
                                    ...
                                    if !aOp_1.is_null() {
                                        (*aOp_1.offset(0 as ::core::ffi::c_int as isize)).p2 = 1
                                            as ::core::ffi::c_int - mxErr;
                                        (*aOp_1.offset(2 as ::core::ffi::c_int as isize)).p4type = P4_STATIC
                                            as ::core::ffi::c_schar;
                                        let ref mut c2rust_fresh3 = (*aOp_1
                                            .offset(2 as ::core::ffi::c_int as isize))
                                            .p4
                                            .z;
                                        *c2rust_fresh3 = b"ok\0".as_ptr()
                                            as *const ::core::ffi::c_char as *mut ::core::ffi::c_char;
                                        (*aOp_1.offset(5 as ::core::ffi::c_int as isize)).p4type = P4_STATIC
                                            as ::core::ffi::c_schar;
                                        let ref mut c2rust_fresh4 = (*aOp_1
                                ...
                                PragTyp_ENCODING => {
                                    ...
                                    if zRight.is_null() {
                                        ...
                                        if (*db).mDbFlags & DBFLAG_EncodingFixed as u32_0
                                            == 0 as u32_0
                                        {
                                ...
                                PragTyp_HEADER_VALUE => {
                                            ...
                                            & PragFlg_ReadOnly == 0 as ::core::ffi::c_int
                                    {
                                        ...
                                        (*aOp_2.offset(1 as ::core::ffi::c_int as isize)).p3 = sqlite3Atoi(
                                            zRight,
                                        );
                                        (*aOp_2.offset(1 as ::core::ffi::c_int as isize)).p5 = 1
                                            as u16_0;
                                        if iCookie == BTREE_SCHEMA_VERSION
                                            && (*db).flags as ::core::ffi::c_ulonglong
                                                ...
                                                != 0 as ::core::ffi::c_ulonglong
                                        {
                                            (*aOp_2.offset(1 as ::core::ffi::c_int as isize)).opcode = OP_Noop
                                                as u8_0;
                                        }
                                    } else {
                                ...
                                PragTyp_OPTIMIZE => {
                                    ...
                                    if !zRight.is_null() {
                                        ...
                                        if opMask & 0x2 as u32_0 == 0 as u32_0 {
                                            ...
                                            c2rust_current_block = 12301477442606723217;
                                        }
                                    } else {
                                        ...
                                        _ => {
                                            ...
                                            while iDb <= iDbLast {
                                                if !(iDb == 1 as ::core::ffi::c_int) {
                                                    ...
                                                    let mut c2rust_current_block_966: u64;
                                                    ...
                                                    while !k_3.is_null() {
                                                        ...
                                                        if (*pTab_11).eTabType as ::core::ffi::c_int == TABTYP_NORM
                                                        {
                                                                ...
                                                                ))
                                                            {
                                                                ...
                                                                if (*pTab_11).tabFlags & TF_MaybeReanalyze as u32_0
                                                                    != 0 as u32_0
                                                                {
                                                                    c2rust_current_block_966 = 3733147086002097443;
                                                                        ...
                                                                        < 0 as ::core::ffi::c_int
                                                                {
                                                                    ...
                                                                    c2rust_current_block_966 = 4707016446154836770;
                                                                }
                                                                match c2rust_current_block_966 {
                                                                    4707016446154836770 => {}
                                                                    _ => {
                                                                        nCheck += 1;
                                                ...
                                                && nBtree > 100 as ::core::ffi::c_int
                                            {
                                                ...
                                                let mut aOp_4: *mut VdbeOp = ::core::ptr::null_mut::<
                                                    VdbeOp,
                                                >();
                                ...
                                PragTyp_LOCK_STATUS => {
                                    static mut azLockName: [*const ::core::ffi::c_char; 5] = [
                                        b"unlocked\0".as_ptr() as *const ::core::ffi::c_char,
                                        b"shared\0".as_ptr() as *const ::core::ffi::c_char,
                                        b"reserved\0".as_ptr() as *const ::core::ffi::c_char,
                                        b"pending\0".as_ptr() as *const ::core::ffi::c_char,
                                        b"exclusive\0".as_ptr() as *const ::core::ffi::c_char,
                                    ];
                                    ...
                                    while i_10 < (*db).nDb {
                                        let mut pBt_2: *mut Btree = ::core::ptr::null_mut::<
                                            Btree,
                                        >();
                                        let mut zState: *const ::core::ffi::c_char = b"unknown\0"
                                            .as_ptr() as *const ::core::ffi::c_char;
                                        ...
                                        if !(*(*db).aDb.offset(i_10 as isize)).zDbSName.is_null() {
                                            ...
                                            if pBt_2.is_null() || sqlite3BtreePager(pBt_2).is_null() {
                                                zState = b"closed\0".as_ptr() as *const ::core::ffi::c_char;
...
static mut aPragmaName: [PragmaName; 67] = [
    ...
    PragmaName {
        zName: b"default_cache_size\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    PragmaName {
        zName: b"lock_status\0".as_ptr() as *const ::core::ffi::c_char,
