            ...
            if c == 0 as ::core::ffi::c_int {
                ...
                match xtype as ::core::ffi::c_int {
                    etPOINTER => {
                        ...
                        c2rust_current_block = 16119533293812266576;
                    }
                    etORDINAL | etRADIX => {
                        c2rust_current_block = 16119533293812266576;
                    }
                    etDECIMAL => {
                        c2rust_current_block = 10861016926129603098;
                    }
                    ...
                    etCHARX => {
                        ...
                        bufpt = &raw mut buf as *mut ::core::ffi::c_char;
                        flag_altform2 = 1 as etByte;
                        c2rust_current_block = 17249620035112123608;
                    }
                    etSTRING | etDYNSTRING => {
                        ...
                        if bufpt.is_null() {
                            ...
                            if (*pAccum).nChar == 0 as u32_0 && (*pAccum).mxAlloc != 0
                                && width == 0 as ::core::ffi::c_int
                                && precision < 0 as ::core::ffi::c_int
    ...
    unsafe {
        while !pExpr.is_null()
            && ((*pExpr).flags
                ...
                != 0 as u32_0 || (*pExpr).w.iOfst <= 0 as ::core::ffi::c_int)
        {
            pExpr = (*pExpr).pLeft;
        }
        if pExpr.is_null() {
...
pub unsafe extern "C" fn sqlite3StrAccumEnlarge(
    ...
    unsafe {
        ...
        if (*p).mxAlloc == 0 as u32_0 {
            ...
            return (*p).nAlloc.wrapping_sub((*p).nChar).wrapping_sub(1 as u32_0)
                as ::core::ffi::c_int;
        } else {
            ...
            if !zNew.is_null() {
                if !((*p).printfFlags as ::core::ffi::c_int & SQLITE_PRINTF_MALLOCED
                    != 0 as ::core::ffi::c_int) && (*p).nChar > 0 as u32_0
                {
                    memcpy(
    ...
    unsafe {
        if (*p).nChar.wrapping_add(N as u32_0) >= (*p).nAlloc {
            ...
            (*p).nChar = ((*p).nChar as ::core::ffi::c_uint)
                .wrapping_add(N as ::core::ffi::c_uint) as u32_0 as u32_0;
            memcpy(
                (*p).zText.offset((*p).nChar.wrapping_sub(N as u32_0) as isize)
...
pub unsafe extern "C" fn sqlite3_str_length(
    ...
    unsafe {
        return (if !p.is_null() { (*p).nChar } else { 0 as u32_0 })
            as ::core::ffi::c_int;
    }
}
#[no_mangle]
