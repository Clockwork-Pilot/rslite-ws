...
pub const SQLITE_LOCKED_SHAREDCACHE: ::core::ffi::c_int = SQLITE_LOCKED
...
pub const SQLITE_OK_SYMLINK: ::core::ffi::c_int = SQLITE_OK
    | (2 as ::core::ffi::c_int) << 8 as ::core::ffi::c_int;
...
#[no_mangle]
pub static mut sqlite3SharedCacheList: *mut BtShared = ::core::ptr::null::<BtShared>()
    as *mut BtShared;
#[no_mangle]
...
unsafe extern "C" fn querySharedCacheTableLock(
    ...
    unsafe {
        ...
        if (*pBt).pWriter != p
            && (*pBt).btsFlags as ::core::ffi::c_int & BTS_EXCLUSIVE
                != 0 as ::core::ffi::c_int
        {
...
unsafe extern "C" fn setSharedCacheTableLock(
    ...
    unsafe {
        ...
        if pLock.is_null() {
            pLock = sqlite3MallocZero(::core::mem::size_of::<BtLock>() as u64_0)
                as *mut BtLock;
            if pLock.is_null() {
...
unsafe extern "C" fn clearAllSharedCacheTableLocks(mut p: *mut Btree) {
    unsafe {
        ...
        if (*pBt).pWriter == p {
            ...
            (*pBt).btsFlags = ((*pBt).btsFlags as ::core::ffi::c_int
                & !(BTS_EXCLUSIVE | BTS_PENDING)) as u16_0;
        } else if (*pBt).nTransaction == 2 as ::core::ffi::c_int {
            (*pBt).btsFlags = ((*pBt).btsFlags as ::core::ffi::c_int & !BTS_PENDING)
                as u16_0;
        }
    }
}
...
unsafe extern "C" fn ptrmapPageno(mut pBt: *mut BtShared, mut pgno: Pgno) -> Pgno {
    unsafe {
        ...
        iPtrMap = pgno.wrapping_sub(2 as Pgno).wrapping_div(nPagesPerMapPage as Pgno);
        ret = iPtrMap.wrapping_mul(nPagesPerMapPage as Pgno).wrapping_add(2 as Pgno);
        if ret
    ...
    unsafe {
            ...
            != 0 as ::core::ffi::c_int
        {
            *pRC = sqlite3CorruptError(1088 as ::core::ffi::c_int);
            ...
            offset = (5 as Pgno)
                .wrapping_mul(key.wrapping_sub(iPtrmap).wrapping_sub(1 as Pgno))
                as ::core::ffi::c_int;
...
unsafe extern "C" fn ptrmapGet(
    ...
    unsafe {
        ...
        pPtrmap = sqlite3PagerGetData(pDbPage) as *mut u8_0;
        offset = (5 as Pgno)
            .wrapping_mul(key.wrapping_sub(iPtrmap as Pgno).wrapping_sub(1 as Pgno))
            as ::core::ffi::c_int;
        if offset < 0 as ::core::ffi::c_int {
            sqlite3PagerUnref(pDbPage);
        ...
        if nPayload <= maxLocal as ::core::ffi::c_longlong {
            ...
            surplus = (minLocal as ::core::ffi::c_longlong
                + (nPayload as ::core::ffi::c_longlong
                    ...
                    % (*(*pPage).pBt).usableSize.wrapping_sub(4 as u32_0)
    ...
    unsafe {
        ...
        if nPayload >= 0x80 as u32_0 {
            let mut pEnd: *mut u8_0 = pIter.offset(8 as ::core::ffi::c_int as isize)
                as *mut u8_0;
            nPayload = (nPayload as ::core::ffi::c_uint & 0x7f as ::core::ffi::c_uint)
                as u32_0;
            loop {
...
unsafe extern "C" fn cellSizePtr(
    ...
    unsafe {
        ...
        if nSize >= 0x80 as u32_0 {
            ...
            nSize = (nSize as ::core::ffi::c_uint & 0x7f as ::core::ffi::c_uint)
                as u32_0;
            loop {
                pIter = pIter.offset(1);
...
unsafe extern "C" fn pageFindSlot(
    ...
    unsafe {
        ...
        let mut maxPC: ::core::ffi::c_int = (*(*pPg).pBt)
            .usableSize
            .wrapping_sub(nByte as u32_0) as ::core::ffi::c_int;
        let mut size: ::core::ffi::c_int = 0;
        while pc <= maxPC {
    ...
    unsafe {
        ...
        if gap > top {
            if top == 0 as ::core::ffi::c_int
                && (*(*pPage).pBt).usableSize == 65536 as u32_0
            {
...
unsafe extern "C" fn btreeInitPage(mut pPage: *mut MemPage) -> ::core::ffi::c_int {
    unsafe {
        ...
        if (*pPage).nCell as u32_0
            > (*pBt).pageSize.wrapping_sub(8 as u32_0).wrapping_div(6 as u32_0)
        {
...
unsafe extern "C" fn zeroPage(mut pPage: *mut MemPage, mut flags: ::core::ffi::c_int) {
    unsafe {
        ...
        *(data.offset((hdr + 5 as ::core::ffi::c_int) as isize)
            ...
            as ::core::ffi::c_uchar;
        (*pPage).nFree = (*pBt).usableSize.wrapping_sub(first as u32_0) as u16_0
            as ::core::ffi::c_int;
    ...
    unsafe {
                ...
                || vfsFlags & SQLITE_OPEN_URI != 0 as ::core::ffi::c_int)
        {
            if vfsFlags & SQLITE_OPEN_SHAREDCACHE != 0 {
                let mut nFilename: ::core::ffi::c_int = sqlite3Strlen30(zFilename)
                    + 1 as ::core::ffi::c_int;
                let mut nFullPathname: ::core::ffi::c_int = (*pVfs).mxPathname
                    + 1 as ::core::ffi::c_int;
                let mut zFullPathname: *mut ::core::ffi::c_char = sqlite3Malloc(
                    (if nFullPathname > nFilename { nFullPathname } else { nFilename })
                        as u64_0,
                ) as *mut ::core::ffi::c_char;
                let mut mutexShared: *mut sqlite3_mutex = ::core::ptr::null_mut::<
                    sqlite3_mutex,
                >();
                ...
                while !pBt.is_null() {
                        ...
                        ) && sqlite3PagerVfs((*pBt).pPager) == pVfs
                    {
                        ...
                        while iDb >= 0 as ::core::ffi::c_int {
                            let mut pExisting: *mut Btree = (*(*db)
                                .aDb
                                .offset(iDb as isize))
                                .pBt;
        ...
        if pBt.is_null() {
            ...
            if pBt.is_null() {
                rc = SQLITE_NOMEM_BKPT;
                c2rust_current_block = 2151552157618012164;
            } else {
                rc = sqlite3PagerOpen(
                    pVfs,
                    &raw mut (*pBt).pPager,
                ...
                if rc != SQLITE_OK {
                    ...
                    if rc != 0 {
                        ...
                        (*pBt).usableSize = (*pBt)
                            .pageSize
                            .wrapping_sub(nReserve as u32_0);
                        (*pBt).nRef = 1 as ::core::ffi::c_int;
                        if (*p).sharable != 0 {
                            let mut mutexShared_0: *mut sqlite3_mutex = ::core::ptr::null_mut::<
                                sqlite3_mutex,
                            >();
                                ...
                                && sqlite3Config.bCoreMutex as ::core::ffi::c_int != 0
                            {
                                ...
                                if (*pBt).mutex.is_null() {
                                    ...
                                    c2rust_current_block = 2750570471926810434;
                                }
                            } else {
                                c2rust_current_block = 2750570471926810434;
                            }
                            match c2rust_current_block {
                                ...
                                _ => {
                                    ...
                                    c2rust_current_block = 7301440000599063274;
                                }
                            }
                        } else {
                            c2rust_current_block = 7301440000599063274;
...
unsafe extern "C" fn lockBtree(mut pBt: *mut BtShared) -> ::core::ffi::c_int {
    unsafe {
        ...
        if nPage > 0 as u32_0 {
            ...
            {
                c2rust_current_block = 1410438069681376046;
            } else {
                        ...
                        _ => {
                            ...
                            ) != 0 as ::core::ffi::c_int
                            {
                                ...
                                if pageSize.wrapping_sub(1 as u32_0) & pageSize
                                    != 0 as u32_0 || pageSize > SQLITE_MAX_PAGE_SIZE as u32_0
...
unsafe extern "C" fn newDatabase(mut pBt: *mut BtShared) -> ::core::ffi::c_int {
    unsafe {
        ...
        *data.offset(16 as ::core::ffi::c_int as isize) = ((*pBt).pageSize
            >> 8 as ::core::ffi::c_int & 0xff as u32_0) as u8_0 as ::core::ffi::c_uchar;
        *data.offset(17 as ::core::ffi::c_int as isize) = ((*pBt).pageSize
            >> 16 as ::core::ffi::c_int & 0xff as u32_0) as u8_0 as ::core::ffi::c_uchar;
    ...
    unsafe {
            ...
            || (*p).inTrans as ::core::ffi::c_int == TRANS_READ && wrflag == 0)
        {
                ...
                != 0 as ::core::ffi::c_int && wrflag != 0
            {
                ...
                if wrflag != 0
                    && (*pBt).inTransaction as ::core::ffi::c_int == TRANS_WRITE
                    || (*pBt).btsFlags as ::core::ffi::c_int & BTS_PENDING
                        != 0 as ::core::ffi::c_int
                {
            ...
            while nextPage != 0 {
                ...
                *(*pCur).aOverflow.offset(iIdx as isize) = nextPage;
                if offset >= ovflSize {
                    ...
                    if eOp == 0 as ::core::ffi::c_int && offset == 0 as u32_0
                            ...
                            as *mut ::core::ffi::c_uchar >= pBufStart
                    {
                        ...
                        rc = sqlite3OsRead(
                            ...
                            (*pBt).pageSize as i64_0
                                * nextPage.wrapping_sub(1 as Pgno) as i64_0,
                        );
    ...
    unsafe {
        ...
        if (*pCur).iPage as ::core::ffi::c_int >= 0 as ::core::ffi::c_int {
            if (*pCur).iPage != 0 {
                ...
                pRoot = (*pCur).pPage;
                c2rust_current_block = 16338858455384990803;
            } else {
        ...
        loop {
            ...
            loop {
                ...
                if nCellKey < intKey {
                    ...
                    if (*pPage).leaf == 0 {
                        lwr = idx;
                        c2rust_current_block = 16220519834796567707;
                        break;
                    } else {
                        (*pCur).curFlags = ((*pCur).curFlags as ::core::ffi::c_int
                                ...
                                if rc != SQLITE_OK {
                                    ...
                                    memcpy(
                                        ...
                                        (*pTrunk).aData.offset(12 as ::core::ffi::c_int as isize)
                                            as *mut u8_0 as *const ::core::ffi::c_void,
                                        k.wrapping_sub(1 as u32_0).wrapping_mul(4 as u32_0)
                                            as size_t,
                                    );
                                    releasePage(pNewTrunk);
                                    if pPrevTrunk.is_null() {
                            ...
                            if eMode as ::core::ffi::c_int == BTALLOC_LE {
                                ...
                                dist = sqlite3AbsInt32(
                                    sqlite3Get4byte(
                                        ...
                                        .wrapping_sub(nearby as u32_0) as ::core::ffi::c_int,
                                );
                                i = 1 as u32_0;
                                while i < k {
                            ...
                            *pPgno = iPage;
                            ...
                            if closest < k.wrapping_sub(1 as u32_0) {
                                memcpy(
                                    ...
                                    aData
                                        .offset(
                                            (4 as u32_0).wrapping_add(k.wrapping_mul(4 as u32_0))
                                                as isize,
                                        ) as *mut ::core::ffi::c_uchar
                                        as *const ::core::ffi::c_void,
                                    4 as size_t,
    ...
    unsafe {
        ...
        if !(rc != 0) {
            ...
            if (*pBt).btsFlags as ::core::ffi::c_int & BTS_SECURE_DELETE != 0 {
                ...
                {
                    c2rust_current_block = 8437957535152080679;
                } else {
                    memset(
                                            ...
                                            if rc == SQLITE_OK {
                                                ...
                                                sqlite3Put4byte(
                                                    (*pTrunk)
                                                        .aData
                                                        .offset(
                                                            (8 as u32_0).wrapping_add(nLeaf.wrapping_mul(4 as u32_0))
                                                                as isize,
                                                        ) as *mut u8_0,
                                                    iPage as u32_0,
                                                );
        ...
        *pnSize = n + nHeader + 4 as ::core::ffi::c_int;
        ...
        loop {
            ...
            if spaceLeft == 0 as ::core::ffi::c_int {
                ...
                spaceLeft = (*pBt).usableSize.wrapping_sub(4 as u32_0)
                    as ::core::ffi::c_int;
            }
        }
        releasePage(pToRelease);
        ...
        if !(pData < pBegin) {
            if !(pData > (*pPg).aDataEnd) {
                if iNew < iOld {
                    ...
                    {
                        c2rust_current_block = 16361979245103043825;
                    } else {
                        nCell += nAdd;
    ...
    unsafe {
        ...
        loop {
            ...
            if rc != 0 {
                ...
                c2rust_current_block = 4360195671368555743;
                break;
            } else {
        ...
        if flags & BTREE_PREFORMAT != 0 {
                ...
                && szNew > (*pPage).maxLocal as ::core::ffi::c_int
            {
                ...
                if info.nPayload != info.nLocal as u32_0 {
                    ...
                    if rc != 0 {
                        c2rust_current_block = 12033647793346913705;
                    } else {
            ...
            if (*pPage).leaf == 0
                || (*pPage).nFree
                    + (*pPage)
                        ...
                        as ::core::ffi::c_int + 2 as ::core::ffi::c_int
                    > (*pBt).usableSize.wrapping_mul(2 as u32_0).wrapping_div(3 as u32_0)
                        as ::core::ffi::c_int
                ...
                != 1 as ::core::ffi::c_int + (pgno == 1 as Pgno) as ::core::ffi::c_int
        {
            ...
            loop {
                ...
                if (*pPage).leaf == 0 {
                    ...
                    if rc != 0 {
                        c2rust_current_block = 1348149925638580262;
                        break;
                    }
                }
                (*pPage)
...
unsafe extern "C" fn getPageReferenced(
    ...
    unsafe {
        return *(*pCheck).aPgRef.offset(iPg.wrapping_div(8 as Pgno) as isize)
            as ::core::ffi::c_int & (1 as ::core::ffi::c_int) << (iPg & 0x7 as Pgno);
    }
}
unsafe extern "C" fn setPageReferenced(mut pCheck: *mut IntegrityCk, mut iPg: Pgno) {
    unsafe {
        ...
        *c2rust_fresh33 = (*c2rust_fresh33 as ::core::ffi::c_int
            | (1 as ::core::ffi::c_int) << (iPg & 0x7 as Pgno)) as u8_0;
    }
}
        ...
        *c2rust_fresh31 = (*c2rust_fresh31).wrapping_sub(1);
        ...
        loop {
            ...
            if *aHeap.offset(j as isize)
                > *aHeap.offset(j.wrapping_add(1 as u32_0) as isize)
            {
                j = j.wrapping_add(1);
            }
                ...
                if rc != 0 as ::core::ffi::c_int {
                    ...
                    if rc != 0 as ::core::ffi::c_int {
                        ...
                        while i >= 0 as ::core::ffi::c_int && (*pCheck).mxErr != 0 {
                            ...
                            if pc < contentOffset
                                || pc > usableSize.wrapping_sub(4 as u32_0)
                            {
                                checkAppendMsg(
                                    pCheck,
                                    ...
                                    nFrag = (nFrag as ::core::ffi::c_uint)
                                        .wrapping_add(
                                            (x >> 16 as ::core::ffi::c_int)
                                                ...
                                                .wrapping_sub(1 as u32_0) as ::core::ffi::c_uint,
    ...
    unsafe {
        ...
        if !(sCheck.nCkPage == 0 as Pgno) {
            sCheck.aPgRef = sqlite3MallocZero(
                sCheck.nCkPage.wrapping_div(8 as Pgno).wrapping_add(1 as Pgno) as u64_0,
            ) as *mut u8_0;
                ...
                if sCheck.heap.is_null() {
                    ...
                    while (i as ::core::ffi::c_int) < nRoot && sCheck.mxErr != 0 {
                        ...
                        if *aRoot.offset(i as isize) != 0 {
                            ...
                            if (*pBt).autoVacuum as ::core::ffi::c_int != 0
                                && *aRoot.offset(i as isize) > 1 as Pgno && bPartial == 0
                            {
                                checkPtrmap(
                                    &raw mut sCheck,
...
pub unsafe extern "C" fn sqlite3BtreeLockTable(
    ...
    unsafe {
        let mut rc: ::core::ffi::c_int = SQLITE_OK;
        if (*p).sharable != 0 {
            let mut lockType: u8_0 = (READ_LOCK + isWriteLock as ::core::ffi::c_int)
                as u8_0;
            sqlite3BtreeEnter(p);
