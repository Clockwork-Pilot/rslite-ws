        ...
        if (*pCollName).n > 0 as ::core::ffi::c_uint {
            ...
            if !pNew.is_null() {
                ...
                (*pNew).flags = ((*pNew).flags as ::core::ffi::c_uint
                    | (EP_Collate | EP_Skip) as ::core::ffi::c_uint) as u32_0;
                pExpr = pNew;
            }
        }
        return pExpr;
...
pub unsafe extern "C" fn sqlite3ExprSkipCollate(mut pExpr: *mut Expr) -> *mut Expr {
    unsafe {
        while !pExpr.is_null()
            && (*pExpr).flags & 0x2000 as ::core::ffi::c_int as u32_0 != 0 as u32_0
        {
            pExpr = (*pExpr).pLeft;
        }
        return pExpr;
    ...
    unsafe {
        ...
        while !p.is_null() {
                    ...
                    && (*p).affExpr as ::core::ffi::c_int == SQLITE_AFF_DEFER
            {
                ...
                if !(*p).pLeft.is_null()
                    && (*(*p).pLeft).flags & EP_Collate as u32_0 != 0 as u32_0
                {
                    p = (*p).pLeft;
                } else {
                        ...
                        && !(*p).x.pList.is_null() && (*db).mallocFailed == 0
                    {
                        ...
                        while i < (*(*p).x.pList).nExpr {
                            if (*(*(&raw mut (*(*p).x.pList).a as *mut ExprList_item)
                                .offset(i as isize))
                                .pExpr)
                                .flags & 0x200 as ::core::ffi::c_int as u32_0 != 0 as u32_0
                            {
...
pub unsafe extern "C" fn sqlite3BinaryCompareCollSeq(
    ...
    unsafe {
        ...
        if (*pLeft).flags & EP_Collate as u32_0 != 0 {
            ...
            && (*pRight).flags & EP_Collate as u32_0 != 0 as u32_0
        {
...
pub unsafe extern "C" fn sqlite3ExprForVectorField(
    ...
    unsafe {
        ...
        if (*pVector).op as ::core::ffi::c_int == TK_SELECT {
            ...
            if !pRet.is_null() {
                (*pRet).flags = ((*pRet).flags as ::core::ffi::c_uint
...
unsafe extern "C" fn codeVectorCompare(
    ...
    unsafe {
        ...
        let mut isCommuted: ::core::ffi::c_int = ((*pExpr).flags
            & 0x400 as ::core::ffi::c_int as u32_0 != 0 as u32_0) as ::core::ffi::c_int;
        if (*pParse).nErr != 0 {
            return;
        }
...
pub unsafe extern "C" fn sqlite3ExprSetErrorOffset(
    ...
    unsafe {
        ...
        if (*pExpr).flags
            & (0x2 as ::core::ffi::c_int | 0x1 as ::core::ffi::c_int) as u32_0
            != 0 as u32_0
        {
            return;
        }
...
pub unsafe extern "C" fn sqlite3ExprAttachSubtrees(
    ...
    unsafe {
        if pRoot.is_null() {
            ...
            if !pRight.is_null() {
                (*pRoot).pRight = pRight;
                (*pRoot).flags = ((*pRoot).flags as ::core::ffi::c_uint
        ...
        if !pExpr.is_null() {
            ...
            (*pExpr).flags = ((*pExpr).flags as ::core::ffi::c_uint
                | (0x1000 as ::core::ffi::c_int | 0x400000 as ::core::ffi::c_int)
                    as u32_0 as ::core::ffi::c_uint) as u32_0;
...
pub unsafe extern "C" fn sqlite3ExprListToValues(
    ...
    unsafe {
        ...
        if !pRet.is_null() && !(*pRet).pPrior.is_null() {
            (*pRet).selFlags = ((*pRet).selFlags as ::core::ffi::c_uint
                | SF_MultiValue as ::core::ffi::c_uint) as u32_0;
        }
...
pub unsafe extern "C" fn sqlite3ExprAnd(
    ...
    unsafe {
        ...
        if pLeft.is_null() {
            ...
            if f & (EP_OuterON | EP_InnerON | EP_IsFalse | EP_HasFunc) as u32_0
                == EP_IsFalse as u32_0
...
pub unsafe extern "C" fn sqlite3ExprFunction(
    ...
    unsafe {
        ...
        (*pNew).x.pList = pList;
        (*pNew).flags = ((*pNew).flags as ::core::ffi::c_uint
            | 0x8 as ::core::ffi::c_int as u32_0 as ::core::ffi::c_uint) as u32_0;
        sqlite3ExprSetHeightAndFlags(pParse, pNew);
        if eDistinct == SF_Distinct {
            (*pNew).flags = ((*pNew).flags as ::core::ffi::c_uint
                | 0x4 as ::core::ffi::c_int as u32_0 as ::core::ffi::c_uint) as u32_0;
        }
        return pNew;
    }
}
...
pub unsafe extern "C" fn sqlite3ExprAddFunctionOrderBy(
    ...
    unsafe {
        ...
        (*pExpr).pLeft = pOB;
        (*pOB).flags = ((*pOB).flags as ::core::ffi::c_uint
            | 0x20000 as ::core::ffi::c_int as u32_0 as ::core::ffi::c_uint) as u32_0;
    }
}
#[no_mangle]
    ...
    unsafe {
        ...
        if !pNew.is_null() {
            ...
            (*pNew).flags = ((*pNew).flags as ::core::ffi::c_uint
                ...
                as u32_0;
            (*pNew).flags = ((*pNew).flags as ::core::ffi::c_uint
                | staticFlag as ::core::ffi::c_uint) as u32_0;
            dupFlags != 0;
            if nToken > 0 as ::core::ffi::c_int {
            ...
            if ((*p).flags | (*pNew).flags) & (EP_TokenOnly | EP_Leaf) as u32_0
                == 0 as u32_0
            {
                if (*p).flags & EP_xIsSelect as u32_0 != 0 as u32_0 {
    ...
    unsafe {
        ...
        while i < (*pList).nExpr {
            let mut pExpr: *mut Expr = (*(&raw const (*pList).a as *const ExprList_item)
                .offset(i as isize))
                .pExpr;
            m = (m as ::core::ffi::c_uint | (*pExpr).flags as ::core::ffi::c_uint)
                as u32_0;
            i += 1;
        }
        return m;
    ...
    unsafe {
            ...
            || (*pExpr).op as ::core::ffi::c_int == TK_OR
        {
            ...
            if (*pLeft).flags & (EP_OuterON | EP_IsTrue) as u32_0 == EP_IsTrue as u32_0
                || (*pRight).flags & (EP_OuterON | EP_IsFalse) as u32_0
                    == EP_IsFalse as u32_0
            {
            ...
            } else if (*pRight).flags & (EP_OuterON | EP_IsTrue) as u32_0
                == EP_IsTrue as u32_0
                || (*pLeft).flags & (EP_OuterON | EP_IsFalse) as u32_0
                    == EP_IsFalse as u32_0
            {
                pExpr = if (*pExpr).op as ::core::ffi::c_int == TK_AND {
                    pLeft
    ...
    unsafe {
        ...
        if addrIsNull == 0 as ::core::ffi::c_int {
            if (*(*pExpr).pRight).flags & 0x400000 as ::core::ffi::c_int as u32_0
                != 0 as u32_0 && sqlite3ExprCanBeNull((*pExpr).pLeft) != 0
            {
...
unsafe extern "C" fn exprNodeIsConstantFunction(
    ...
    unsafe {
        ...
        if pDef.is_null() || (*pDef).xFinalize.is_some()
            || (*pDef).funcFlags & (SQLITE_FUNC_CONSTANT | SQLITE_FUNC_SLOCHNG) as u32_0
                == 0 as u32_0
            || (*pExpr).flags & 0x1000000 as ::core::ffi::c_int as u32_0 != 0 as u32_0
        {
            (*pWalker).eCode = 0 as u16_0;
...
pub unsafe extern "C" fn sqlite3FindInIndex(
    ...
    unsafe {
        ...
        mustBeUnique = (inFlags & IN_INDEX_LOOP as u32_0 != 0 as u32_0)
            as ::core::ffi::c_int;
        ...
        if eType == 0 as ::core::ffi::c_int && inFlags & IN_INDEX_NOOP_OK as u32_0 != 0
...
unsafe extern "C" fn exprINAffinity(
    ...
    unsafe {
        ...
        let mut pSelect: *mut Select = if (*pExpr).flags & EP_xIsSelect as u32_0
            != 0 as u32_0
        {
            (*pExpr).x.pSelect
        } else {
    ...
    unsafe {
        ...
        if (*pExpr).flags & EP_xIsSelect as u32_0 != 0 as u32_0 {
            ...
            if (*pEList).nExpr == nVal {
                ...
                if addrOnce != 0
                    && (*(*pParse).db).dbOptFlags & 0x80000 as u32_0 == 0 as u32_0
                {
                    (*pParse).nMem += 1;
...
pub unsafe extern "C" fn sqlite3CodeSubselect(
    ...
    unsafe {
        ...
        (*pExpr).flags = ((*pExpr).flags as ::core::ffi::c_uint
            | 0x2000000 as ::core::ffi::c_int as u32_0 as ::core::ffi::c_uint) as u32_0;
        (*pParse).nMem += 1;
        (*pExpr).y.sub.regReturn = (*pParse).nMem;
        (*pExpr).y.sub.iAddr = sqlite3VdbeAddOp2(
            v,
        ...
        if (*pExpr).op as ::core::ffi::c_int == TK_SELECT {
            ...
            if (*pSel).selFlags & SF_Distinct as u32_0 != 0 && !(*pSel).pLimit.is_null()
...
pub unsafe extern "C" fn sqlite3ExprCheckIN(
    ...
    unsafe {
        ...
        if (*pIn).flags & EP_xIsSelect as u32_0 != 0 as u32_0
        ...
        if !((*(*pParse).db).mallocFailed != 0) {
            ...
            if eType == IN_INDEX_NOOP {
                ...
                loop {
                    ...
                    if (*pParse).nErr != 0 {
                        c2rust_current_block = 970042548351262943;
                        break;
                    }
...
unsafe extern "C" fn exprNodeCanReturnSubtype(
    ...
    unsafe {
        ...
        pDef = sqlite3FindFunction(db, (*pExpr).u.zToken, n, (*db).enc, 0 as u8_0);
        if pDef.is_null()
            || (*pDef).funcFlags & SQLITE_RESULT_SUBTYPE as u32_0 != 0 as u32_0
        {
                ...
                match c2rust_current_block_21 {
                    ...
                    _ => {
                        ...
                        ) != 0 as ::core::ffi::c_int)
                        {
                            ...
                            {
                                if !((*pExpr).flags
                                    & 0x80000000 as ::core::ffi::c_uint as u32_0 != 0 as u32_0
    ...
    unsafe {
        ...
        loop {
            ...
            match op {
                ...
                TK_COLUMN => {
                    c2rust_current_block = 11118919927399175163;
                    break;
                }
                TK_INTEGER => {
        ...
        match c2rust_current_block {
            1995330570110937187 => {
                    ...
                    && !pFarg.is_null()
                {
                    ...
                    & (SQLITE_FUNC_DIRECT | SQLITE_FUNC_UNSAFE) as u32_0 != 0
                {
                ...
                if !pFarg.is_null() {
                    ...
                    if (*pDef).funcFlags
                        & (SQLITE_FUNC_LENGTH | SQLITE_FUNC_TYPEOF) as u32_0
                        != 0 as u32_0
                    {
                            ...
                            || exprOp as ::core::ffi::c_int == TK_AGG_COLUMN
                        {
                            (*(*(&raw mut (*pFarg).a as *mut ExprList_item)
                                .offset(0 as ::core::ffi::c_int as isize))
                                .pExpr)
                                .op2 = ((*pDef).funcFlags & OPFLAG_BYTELENARG as u32_0)
                                as u8_0;
                        }
                    }
...
pub unsafe extern "C" fn sqlite3ExprCodeRunJustOnce(
    ...
    unsafe {
        ...
        if !pExpr.is_null()
            && (*pExpr).flags & 0x8 as ::core::ffi::c_int as u32_0 != 0 as u32_0
        {
            let mut v: *mut Vdbe = (*pParse).pVdbe;
            let mut addr: ::core::ffi::c_int = 0;
    ...
    unsafe {
        ...
        if (*db).mallocFailed as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            ...
            if xJump.is_some() {
                ...
                (*pDel).flags = ((*pDel).flags as ::core::ffi::c_uint
                    | EP_OuterON as ::core::ffi::c_uint) as u32_0;
...
pub unsafe extern "C" fn sqlite3ExprIfTrue(
    ...
    unsafe {
        ...
        match op {
            ...
            _ => {
                c2rust_current_block_108 = 372674300092992628;
            }
        }
        match c2rust_current_block_108 {
            15090052786889560393 => {
                ...
                if sqlite3ExprIsVector((*pExpr).pLeft) != 0 {
                    ...
                    if (*pExpr).flags & 0x400000 as ::core::ffi::c_int as u32_0
                        != 0 as u32_0 && jumpIfNull != SQLITE_NULLEQ
                    {
                        addrIsNull = exprComputeOperands(
                            pParse,
                            pExpr,
        ...
        match c2rust_current_block_108 {
            372674300092992628 => {
                if (*pExpr).flags & (EP_OuterON | EP_IsTrue) as u32_0
                    == EP_IsTrue as u32_0
                {
                    sqlite3VdbeGoto(v, dest);
                } else if !((*pExpr).flags & (EP_OuterON | EP_IsFalse) as u32_0
                    == EP_IsFalse as u32_0)
                {
...
pub unsafe extern "C" fn sqlite3ExprIfFalse(
    ...
    unsafe {
        ...
        match (*pExpr).op as ::core::ffi::c_int {
            ...
            _ => {
                c2rust_current_block_117 = 14023238700356768474;
            }
        }
        ...
        match c2rust_current_block_117 {
            14023238700356768474 => {
                if (*pExpr).flags & (EP_OuterON | EP_IsFalse) as u32_0
                    == EP_IsFalse as u32_0
                {
                    sqlite3VdbeGoto(v, dest);
                } else if !((*pExpr).flags & (EP_OuterON | EP_IsTrue) as u32_0
                    == EP_IsTrue as u32_0)
                {
                    r1 = sqlite3ExprCodeTemp(pParse, pExpr, &raw mut regFree1);
                    sqlite3VdbeAddOp3(
        ...
        's_167: {
            ...
            match (*p).op as ::core::ffi::c_int {
                ...
                | TK_CONCAT => {
                    ...
                    c2rust_current_block_36 = 16055551007735776550;
                }
                TK_STAR | TK_REM | TK_BITAND | TK_SLASH => {
                    c2rust_current_block_36 = 16055551007735776550;
                }
                TK_SPAN | TK_COLLATE | TK_UPLUS | TK_UMINUS => {
                    c2rust_current_block_36 = 14892366756963034630;
                }
                TK_TRUTH => {
                    if seenNot != 0 {
                        return 0 as ::core::ffi::c_int;
...
unsafe extern "C" fn agginfoPersistExprCb(
    ...
    unsafe {
        if !((*pExpr).flags
            ...
            != 0 as u32_0) && !(*pExpr).pAggInfo.is_null()
        {
                        ...
                        if i >= 0 as ::core::ffi::c_int {
                            ...
                            if !(*pExpr).pLeft.is_null()
                                && (*(*pItem_0).pFunc).funcFlags
                                    & SQLITE_FUNC_NEEDCOLL as u32_0 == 0 as u32_0
                            {
