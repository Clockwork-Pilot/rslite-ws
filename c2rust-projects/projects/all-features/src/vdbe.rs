...
unsafe extern "C" fn updateMaxBlobsize(mut p: *mut Mem) {
    unsafe {
        if (*p).flags as ::core::ffi::c_int & (MEM_Str | MEM_Blob)
            != 0 as ::core::ffi::c_int && (*p).n > sqlite3_max_blobsize
        {
    ...
    unsafe {
        ...
        if (*db).xProgress.is_some() {
            ...
            nProgressLimit = ((*db).nProgressOps as u32_0)
                .wrapping_sub(iPrior.wrapping_rem((*db).nProgressOps as u32_0)) as u64_0;
        } else {
            nProgressLimit = LARGEST_UINT64;
        }
        if (*p).rc == SQLITE_NOMEM {
            c2rust_current_block = 6479030522755537372;
        } else {
            (*p).rc = SQLITE_OK;
            ...
            if (*db).u1.isInterrupted
                != 0
            {
                c2rust_current_block = 9771092749923633615;
            } else {
                ...
                's_109: loop {
                    ...
                    match (*pOp).opcode as ::core::ffi::c_int {
                        OP_Goto => {
                            c2rust_current_block = 3155957218509077512;
                        }
                        OP_Gosub => {
                        ...
                        OP_InitCoroutine => {
                            ...
                            if (*pOp).p2 == 0 as ::core::ffi::c_int {
                                ...
                                c2rust_current_block = 9512719473022792396;
                            }
                        }
                        OP_EndCoroutine => {
                        ...
                        OP_HaltIfNull => {
                                ...
                                == 0 as ::core::ffi::c_int
                            {
                                ...
                                c2rust_current_block = 10435735846551762309;
                            }
                        }
                        OP_Halt => {
                            c2rust_current_block = 10435735846551762309;
                        ...
                        OP_String8 => {
                            ...
                            if encoding as ::core::ffi::c_int != SQLITE_UTF8 {
                                ...
                                if rc != 0 {
                                    c2rust_current_block = 12340572554808228587;
                                    break;
                                }
                                if SQLITE_OK
                            ...
                            c2rust_current_block = 16937825661756021828;
                        }
                        OP_String => {
                            c2rust_current_block = 16937825661756021828;
                        }
                        ...
                        OP_FkCheck => {
                            ...
                            if rc != SQLITE_OK {
                                c2rust_current_block = 6612382128124046637;
                                break;
                            }
                            c2rust_current_block = 5783071609795492627;
                        }
                        OP_ResultRow => {
                            (*p).cacheCtr = (*p).cacheCtr.wrapping_add(2 as u32_0)
                                | 1 as u32_0;
                            ...
                            rc = SQLITE_ROW;
                            c2rust_current_block = 10408586827809538586;
                            break;
                        }
                        OP_Concat => {
                            let mut nByte: i64_0 = 0;
                        ...
                        OP_Add => {
                            c2rust_current_block = 2391757736763964346;
                        }
                        OP_Subtract => {
                            c2rust_current_block = 2391757736763964346;
                        }
                        OP_Multiply => {
                            c2rust_current_block = 7578504260019127541;
                        }
                        OP_Divide => {
                            c2rust_current_block = 11013268710243907980;
                        }
                        OP_Remainder => {
                            c2rust_current_block = 11475295656646479480;
                        }
                        OP_CollSeq => {
                            if (*pOp).p1 != 0 {
                        ...
                        OP_BitAnd => {
                            c2rust_current_block = 13516513776887585379;
                        }
                        OP_BitOr => {
                            c2rust_current_block = 13516513776887585379;
                        }
                        OP_ShiftLeft => {
                            c2rust_current_block = 907265988263712014;
                        }
                        OP_ShiftRight => {
                            c2rust_current_block = 1895500680468589183;
                        }
                        OP_AddImm => {
                            pIn1 = aMem.offset((*pOp).p1 as isize) as *mut Mem;
                        ...
                        OP_MustBeInt => {
                                ...
                                == 0 as ::core::ffi::c_int
                            {
                                    ...
                                    == 0 as ::core::ffi::c_int
                                {
                                    ...
                                    c2rust_current_block = 7073745033006193998;
                                }
                            } else {
                                c2rust_current_block = 7073745033006193998;
                            }
                        ...
                        OP_Eq => {
                            c2rust_current_block = 1222573978657214552;
                        }
                        OP_Ne => {
                            c2rust_current_block = 1222573978657214552;
                        }
                        OP_Lt => {
                            c2rust_current_block = 10512138841805316424;
                        }
                        OP_Le => {
                            c2rust_current_block = 17943868747635332468;
                        }
                        OP_Gt => {
                            c2rust_current_block = 2696725697150177121;
                        }
                        OP_Ge => {
                            c2rust_current_block = 9598485154371622742;
                        }
                        OP_ElseEq => {
                        ...
                        OP_And => {
                            c2rust_current_block = 10856689599696957676;
                        }
                        OP_Or => {
                            c2rust_current_block = 10856689599696957676;
                        }
                            ...
                            if !(*p).pFrame.is_null() {
                                    ...
                                    != 0 as ::core::ffi::c_int
                                {
                                    ...
                                    *c2rust_fresh2 = (*c2rust_fresh2 as ::core::ffi::c_int
                                        | (1 as ::core::ffi::c_int) << (iAddr & 7 as u32_0))
                                        as u8_0;
                                    c2rust_current_block = 11642008854238505342;
                                }
                            } else if (*(*p)
                                .aOp
                        ...
                        OP_Column => {
                            ...
                            loop {
                                ...
                                if (*pC_1).cacheStatus != (*p).cacheCtr {
                                    if (*pC_1).nullRow != 0 {
                                        ...
                                        {
                                            c2rust_current_block = 9495722216958262053;
                                            break;
                                        } else {
                                            c2rust_current_block = 1975004770106644911;
                                            break;
                                        }
                                    } else {
                                        ...
                                        if (*pC_1).deferredMoveto != 0 {
                                                ...
                                                }
                                            {
                                                ...
                                                if rc != 0 {
                                                    ...
                                                    c2rust_current_block = 13246752163818097729;
                                                    break;
                                                }
                                            }
                                        } else {
                                    ...
                                    if !(sqlite3BtreeCursorHasMoved((*pC_1).uc.pCursor) != 0) {
                                        c2rust_current_block = 9147150541555199843;
                                        break;
                                    }
                                    rc = sqlite3VdbeHandleMovedCursor(pC_1);
                                    if rc != 0 {
                            ...
                            match c2rust_current_block {
                                13246752163818097729 => {
                                    ...
                                    c2rust_current_block = 4580464979391500237;
                                }
                                1975004770106644911 => {
                                    pDest = aMem.offset((*pOp).p3 as isize) as *mut Mem;
                                    sqlite3VdbeMemSetNull(pDest);
                                    c2rust_current_block = 17941537588005085186;
                                }
                                9495722216958262053 => {
                            ...
                            match c2rust_current_block {
                                4580464979391500237 => {
                                    ...
                                    *c2rust_fresh3 = *(*pC_1)
                                    ...
                                    if *c2rust_fresh3 < 0x80 as u32_0 {
                                        ...
                                        < *aOffset.offset(0 as ::core::ffi::c_int as isize)
                                    {
                                        ...
                                        if *aOffset.offset(0 as ::core::ffi::c_int as isize)
                                            ...
                                            || *aOffset.offset(0 as ::core::ffi::c_int as isize)
                                                > (*pC_1).payloadSize
                                        {
                                            c2rust_current_block = 6272116254892760061;
                                        } else {
                                            c2rust_current_block = 9147150541555199843;
                                        }
                                    } else {
                                        zData = (*pC_1).aRow;
                                        c2rust_current_block = 12059457360366444586;
                                    }
                                }
                                _ => {}
                            }
                                ...
                                9147150541555199843 => {
                                    if (*pC_1).nHdrParsed as u32_0 <= p2_1 {
                                            ...
                                            < *aOffset.offset(0 as ::core::ffi::c_int as isize)
                                        {
                                            ...
                                            t = 0 as u32_0;
                                            c2rust_current_block = 13908727566713266484;
                                        }
                                    } else {
                                        t = *(&raw mut (*pC_1).aType as *mut u32_0)
                                            .offset(p2_1 as isize);
                                        c2rust_current_block = 2644446111302234773;
                                    }
                                }
                                _ => {}
                            }
                            match c2rust_current_block {
                                12059457360366444586 => {
                                    ...
                                    loop {
                                        ...
                                        let ref mut c2rust_fresh4 = *(&raw mut (*pC_1).aType
                                            ...
                                            .offset(i_0 as isize);
                                        *c2rust_fresh4 = t;
                                        if *c2rust_fresh4 < 0x80 as u32_0 {
                                            zHdr = zHdr.offset(1);
                                            ...
                                            > (*pC_1).payloadSize as ::core::ffi::c_ulonglong
                                    {
                                            ...
                                            == 0 as u32_0
                                        {
                                            ...
                                            zHdr = zEndHdr;
                                            c2rust_current_block = 14847419611938267583;
                                        } else {
                                            if (*pC_1).aRow.is_null() {
                                ...
                                _ => {
                                    match c2rust_current_block {
                                        2644446111302234773 => {
                                            ...
                                            if (*pC_1).szRow
                                                >= *aOffset.offset(p2_1.wrapping_add(1 as u32_0) as isize)
                                            {
                                                zData = (*pC_1)
                                                    .aRow
                                                ...
                                                if t < 12 as u32_0 {
                                                    ...
                                                    len = t.wrapping_sub(12 as u32_0).wrapping_div(2 as u32_0)
                                                        as ::core::ffi::c_int;
                                                    (*pDest).n = len;
                                                    (*pDest).enc = encoding;
                            ...
                            loop {
                                    ...
                                    && (*pOp).p3 < 2 as ::core::ffi::c_int
                                {
                                    if (*aCol.offset(i_1 as isize)).colFlags
                                        ...
                                        != 0 as ::core::ffi::c_int
                                    {
                                        c2rust_current_block = 9099392116323677207;
                                    } else if (*pOp).p3 != 0 {
                                        pIn1 = pIn1.offset(1);
                                        c2rust_current_block = 9099392116323677207;
                                    } else {
                                        c2rust_current_block = 14461663267880372962;
                                    }
                                } else {
                                    c2rust_current_block = 14461663267880372962;
                                }
                                match c2rust_current_block {
                                    14461663267880372962 => {
                                            ...
                                            == 0 as ::core::ffi::c_int
                                        {
                                            ...
                                            {
                                                COLTYPE_BLOB => {
                                                    c2rust_current_block = 18205226828399833612;
                                                    match c2rust_current_block {
                                                        3518619798157913413 => {
                                                            if (*pIn1).flags as ::core::ffi::c_int & MEM_Str
                                                                == 0 as ::core::ffi::c_int
                                                            {
                                                                c2rust_current_block = 3301957169104814111;
                                                                break;
                                                            }
                                                        }
                                                ...
                                                COLTYPE_INTEGER | COLTYPE_INT => {
                                                    c2rust_current_block = 10371895734591966926;
                                                    match c2rust_current_block {
                                                        3518619798157913413 => {
                                                            if (*pIn1).flags as ::core::ffi::c_int & MEM_Str
                                                                == 0 as ::core::ffi::c_int
                                                ...
                                                COLTYPE_TEXT => {
                                                    c2rust_current_block = 3518619798157913413;
                                                    match c2rust_current_block {
                                                        3518619798157913413 => {
                                                            if (*pIn1).flags as ::core::ffi::c_int & MEM_Str
                                                                == 0 as ::core::ffi::c_int
                                                ...
                                                COLTYPE_REAL => {
                                                    c2rust_current_block = 6603035963279056686;
                                                    match c2rust_current_block {
                                                        3518619798157913413 => {
                                                            if (*pIn1).flags as ::core::ffi::c_int & MEM_Str
                                                                == 0 as ::core::ffi::c_int
                                    ...
                                    serial_type = len_0
                                        ...
                                        .wrapping_add(
                                            ((*pRec).flags as ::core::ffi::c_int & MEM_Str
                                                != 0 as ::core::ffi::c_int) as ::core::ffi::c_int as u32_0,
                                        );
                                    if (*pRec).flags as ::core::ffi::c_int & MEM_Zero != 0 {
                                ...
                                if serial_type <= 7 as u32_0 {
                                    ...
                                    *c2rust_fresh6 = serial_type as u8_0;
                                    if !(serial_type == 0 as u32_0) {
                                        ...
                                        let mut c2rust_current_block_959: u64;
                                        match len_0 {
                                            6 => {
                                                c2rust_current_block_959 = 9538761531957144916;
                                            }
                                            4 => {
                                                c2rust_current_block_959 = 3923164313001667094;
                                            }
                                            3 => {
                                                c2rust_current_block_959 = 9558650129454210819;
                                            }
                                            2 => {
                                                c2rust_current_block_959 = 13401043146571671148;
                                            }
                                            1 => {
                                                c2rust_current_block_959 = 11733861603057376683;
                                            }
                                            _ => {
                                        ...
                                        match c2rust_current_block_959 {
                                            9538761531957144916 => {
                        ...
                        OP_Count => {
                            ...
                            pOut = out2Prerelease(p, pOp as *mut VdbeOp);
                            (*pOut).u.i = nEntry;
                            c2rust_current_block = 5157744496741645581;
                        }
                        OP_Savepoint => {
                                    ...
                                    if isTransaction != 0 && p1_1 == SAVEPOINT_RELEASE {
                                        ...
                                        if p1_1 == SAVEPOINT_ROLLBACK {
                                            isSchemaChange = ((*db).mDbFlags
                                                & DBFLAG_SchemaChange as u32_0 != 0 as u32_0)
                                                as ::core::ffi::c_int;
                        ...
                        OP_ReopenIdx => {
                            ...
                            if !pCur.is_null() && (*pCur).pgnoRoot == (*pOp).p2 as u32_0
                            {
                                ...
                                c2rust_current_block = 2376416726268577300;
                            } else {
                                c2rust_current_block = 6098721512207810182;
                            }
                        }
                        ...
                        OP_OpenAutoindex => {
                            c2rust_current_block = 4855994676461051050;
                        }
                        OP_OpenEphemeral => {
                            c2rust_current_block = 4855994676461051050;
                        }
                        ...
                        OP_SeekLT => {
                            c2rust_current_block = 11771517716022779573;
                        }
                        OP_SeekLE => {
                            c2rust_current_block = 11771517716022779573;
                        }
                        OP_SeekGE => {
                            c2rust_current_block = 13977742348402977532;
                        }
                        OP_SeekGT => {
                            c2rust_current_block = 6051598589340159089;
                        }
                        OP_SeekScan => {
                        ...
                        OP_IfNoHope => {
                            ...
                            if (*pC_6).seekHit as ::core::ffi::c_int >= (*pOp).p4.i {
                                ...
                                c2rust_current_block = 9455888639721209236;
                            }
                        }
                        OP_NoConflict => {
                            c2rust_current_block = 9455888639721209236;
                        ...
                        OP_NotFound => {
                            c2rust_current_block = 10517737360991715516;
                        }
                        OP_Found => {
                            c2rust_current_block = 18125716024132132232;
                        }
                        OP_SeekRowid => {
                                ...
                                & (MEM_Int | MEM_IntReal) == 0 as ::core::ffi::c_int
                            {
                                    ...
                                    == 0 as ::core::ffi::c_int
                                {
                                    ...
                                    c2rust_current_block = 14281018696962895891;
                                }
                            } else {
                                c2rust_current_block = 10212326946982022319;
                            }
                        }
                        OP_NotExists => {
                            c2rust_current_block = 10212326946982022319;
                        ...
                        OP_Rowid => {
                            ...
                            if (*pC_15).nullRow != 0 {
                                ...
                                if (*pC_15).deferredMoveto != 0 {
                                    ...
                                    c2rust_current_block = 6117620705961481515;
                        ...
                        OP_SeekEnd => {
                            c2rust_current_block = 3859792399008177139;
                        }
                        OP_Last => {
                            c2rust_current_block = 3859792399008177139;
                        }
                        ...
                        OP_SorterSort | OP_Sort => {
                            ...
                            (*p).aCounter[SQLITE_STMTSTATUS_SORT as usize] = (*p)
                                ...
                                .wrapping_add(1);
                            c2rust_current_block = 3082952251283703534;
                        }
                        OP_Rewind => {
                            c2rust_current_block = 3082952251283703534;
                        }
                        ...
                        OP_SorterNext => {
                            ...
                            c2rust_current_block = 15837986426147350640;
                        }
                        OP_Prev => {
                            pC_21 = *(*p).apCsr.offset((*pOp).p1 as isize);
                        ...
                        OP_DeferredSeek => {
                            c2rust_current_block = 2251003667842051127;
                        }
                        OP_IdxRowid => {
                            c2rust_current_block = 2251003667842051127;
                        }
                        ...
                        OP_IdxLE => {
                            c2rust_current_block = 12193235763041378630;
                        }
                        OP_IdxGT => {
                            c2rust_current_block = 12193235763041378630;
                        }
                        OP_IdxLT => {
                            c2rust_current_block = 2701560784098637822;
                        }
                        OP_IdxGE => {
                            c2rust_current_block = 6380214163151454549;
                        }
                        OP_Destroy => {
                        ...
                        OP_RowSetTest => {
                            ...
                            if iSet != 0 {
                                ...
                                if exists != 0 {
                                    ...
                                    c2rust_current_block = 13046928203416818118;
                                }
                            } else {
                                c2rust_current_block = 13046928203416818118;
                            }
                        ...
                        OP_Program => {
                            ...
                            if (*pOp).p5 != 0 {
                                ...
                                if !pFrame_1.is_null() {
                                    ...
                                    c2rust_current_block = 5564066760466108218;
                                }
                            } else {
                                c2rust_current_block = 5564066760466108218;
                            }
                        ...
                        OP_AggInverse | OP_AggStep => {
                            ...
                            c2rust_current_block = 1931008622201330627;
                        }
                        OP_AggStep1 => {
                            c2rust_current_block = 1931008622201330627;
                        }
                                    ...
                                    == (*db).flags & SQLITE_ReadUncommit
                            {
                                ...
                                if rc != 0 {
                                    if rc & 0xff as ::core::ffi::c_int == SQLITE_LOCKED {
                                        ...
                                        sqlite3VdbeError(
                                            p,
                                            b"database table is locked: %s\0".as_ptr()
                                                as *const ::core::ffi::c_char,
                                            z_0,
                                        );
                                    }
                        ...
                        OP_PureFunc => {
                            c2rust_current_block = 13540359916536463501;
                        }
                        OP_Function => {
                            c2rust_current_block = 13540359916536463501;
                        }
                        ...
                        OP_Trace | OP_Init => {
                            ...
                            {
                                if (*db).mTrace as ::core::ffi::c_int & SQLITE_TRACE_LEGACY
                                    != 0
                                {
                                    let mut z_1: *mut ::core::ffi::c_char = sqlite3VdbeExpandSql(
                                        p,
                                        zTrace,
                                    );
                                    (*db)
                                        .trace
                                        .xLegacy
                                        .expect("non-null function pointer")((*db).pTraceArg, z_1);
                            ...
                            if (*pOp).p1 >= sqlite3Config.iOnceResetThreshold {
                                if (*pOp).opcode as ::core::ffi::c_int == OP_Trace {
                                    ...
                                    c2rust_current_block = 13408672579463531032;
                                }
                            } else {
                                c2rust_current_block = 13408672579463531032;
                            }
                    ...
                    match c2rust_current_block {
                        ...
                        3859792399008177139 => {
                            ...
                            if (*pOp).opcode as ::core::ffi::c_int == OP_SeekEnd {
                                ...
                                if sqlite3BtreeCursorIsValidNN(pCrsr_3) != 0 {
                                    ...
                                    c2rust_current_block = 5427770127893779035;
                                }
                            } else {
                                c2rust_current_block = 5427770127893779035;
                            }
                        ...
                        13516513776887585379 => {
                            c2rust_current_block = 907265988263712014;
                        }
                        1222573978657214552 => {
                            c2rust_current_block = 10512138841805316424;
                        }
                        11771517716022779573 => {
                            c2rust_current_block = 13977742348402977532;
                        }
                        9455888639721209236 => {
                            c2rust_current_block = 10517737360991715516;
                        }
                        12193235763041378630 => {
                            c2rust_current_block = 2701560784098637822;
                        }
                        _ => {}
                    }
                    match c2rust_current_block {
                        14281018696962895891 => {
                            ...
                            if res_2 != 0 as ::core::ffi::c_int {
                                if (*pOp).p2 == 0 as ::core::ffi::c_int {
                                    ...
                                    c2rust_current_block = 13115802299706855851;
                                } else {
                                    c2rust_current_block = 9512719473022792396;
                                }
                            } else {
                        ...
                        10512138841805316424 => {
                            c2rust_current_block = 17943868747635332468;
                        }
                        13977742348402977532 => {
                            c2rust_current_block = 6051598589340159089;
                        }
                        10517737360991715516 => {
                            c2rust_current_block = 18125716024132132232;
                        }
                        2701560784098637822 => {
                            c2rust_current_block = 6380214163151454549;
                    ...
                    match c2rust_current_block {
                                ...
                                if (*pOp).opcode as ::core::ffi::c_int == OP_NoConflict {
                                    ...
                                    loop {
                                        if !(ii_0 < r_1.nField as ::core::ffi::c_int) {
                                            c2rust_current_block = 17613180196767804613;
                                            break;
                                        }
                            ...
                            if (*pC_3).isTable != 0 {
                                    ...
                                    == 0 as ::core::ffi::c_int
                                {
                                        ...
                                        == 0 as ::core::ffi::c_int
                                    {
                                            ...
                                            || oc >= OP_SeekGE
                                        {
                                            ...
                                            c2rust_current_block = 8651270701404509569;
                                        }
                                    } else {
                                        ...
                                        c2rust_current_block = 30898356577063691;
                                    }
                                } else {
                                    c2rust_current_block = 30898356577063691;
                                }
                                match c2rust_current_block {
                                    ...
                                    _ => {
                                        ...
                                        c2rust_current_block = 1453880179885609999;
                                    }
                                }
                            } else {
                        ...
                        11013268710243907980 => {
                            c2rust_current_block = 11475295656646479480;
                        }
                        17943868747635332468 => {
                            c2rust_current_block = 2696725697150177121;
                        }
                        _ => {}
                    }
                    match c2rust_current_block {
                        11475295656646479480 => {
                            ...
                            {
                                c2rust_current_block = 16022352580450589476;
                            } else if (type1 as ::core::ffi::c_int
                                | type2 as ::core::ffi::c_int) & MEM_Null
                                != 0 as ::core::ffi::c_int
                            {
                                c2rust_current_block = 11584477030632456863;
                            } else {
                                    ...
                                    & MEM_Int != 0 as ::core::ffi::c_int
                                {
                                    ...
                                    c2rust_current_block = 2779779509119986892;
                                }
                            }
                            match c2rust_current_block {
                                16022352580450589476 => {
                                    iA = (*pIn1).u.i;
                                    iB = (*pIn2).u.i;
                                    match (*pOp).opcode as ::core::ffi::c_int {
                                        OP_Add => {
                                            if sqlite3AddInt64(&raw mut iB, iA) != 0 {
                                                ...
                                                c2rust_current_block = 14114736409816581360;
                                            }
                                        }
                                        OP_Subtract => {
                                    ...
                                    match c2rust_current_block {
                                        2779779509119986892 => {
                                            ...
                                            match (*pOp).opcode as ::core::ffi::c_int {
                                                OP_Add => {
                                                    rB += rA;
                                                    c2rust_current_block = 7157913506381630964;
                                                }
                                                OP_Subtract => {
                                                    rB -= rA;
                                                    c2rust_current_block = 7157913506381630964;
                                ...
                                != 0 as ::core::ffi::c_int
                            {
                                    ...
                                    | flags3 as ::core::ffi::c_int) & MEM_Null != 0
                                {
                                    if (*pOp).p5 as ::core::ffi::c_int & SQLITE_NULLEQ != 0 {
                                        ...
                                        c2rust_current_block = 915695187752424879;
