        ...
        if !(z >= zEnd) {
            ...
            if !(z >= zEnd) {
                    ...
                    || *z as ::core::ffi::c_int == 'E' as i32
                {
                    ...
                    eType += 1;
                    if z >= zEnd {
                        c2rust_current_block = 11637091607618428085;
                    } else {
                        if *z as ::core::ffi::c_int == '-' as i32 {
    ...
    unsafe {
            ...
            as ::core::ffi::c_int >= 0 as ::core::ffi::c_int
        {
            *v = (((*p.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                & 0x7f as ::core::ffi::c_int) as u32_0) << 7 as ::core::ffi::c_int
        ...
        a = (a as ::core::ffi::c_uint | *p as ::core::ffi::c_uint) as u32_0;
        if a & 0x80 as u32_0 == 0 {
            a = (a as ::core::ffi::c_uint & SLOT_2_0 as ::core::ffi::c_uint) as u32_0;
            b = (b as ::core::ffi::c_uint & 0x7f as ::core::ffi::c_uint) as u32_0;
            b = b << 7 as ::core::ffi::c_int;
            a = (a as ::core::ffi::c_uint | b as ::core::ffi::c_uint) as u32_0;
            *v = a as u64_0;
            return 3 as u8_0;
        }
        a = (a as ::core::ffi::c_uint & SLOT_2_0 as ::core::ffi::c_uint) as u32_0;
        ...
        b = (b as ::core::ffi::c_uint | *p as ::core::ffi::c_uint) as u32_0;
        if b & 0x80 as u32_0 == 0 {
            b = (b as ::core::ffi::c_uint & SLOT_2_0 as ::core::ffi::c_uint) as u32_0;
        ...
        s = (s as ::core::ffi::c_uint | b as ::core::ffi::c_uint) as u32_0;
        p = p.offset(1);
        b = b << 14 as ::core::ffi::c_int;
        b = (b as ::core::ffi::c_uint | *p as ::core::ffi::c_uint) as u32_0;
        if b & 0x80 as u32_0 == 0 {
