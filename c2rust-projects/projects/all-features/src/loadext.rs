...
static mut sqlite3Apis: sqlite3_api_routines = unsafe {
    sqlite3_api_routines {
        ...
        changes: Some(
            sqlite3_changes as unsafe extern "C" fn(*mut sqlite3) -> ::core::ffi::c_int,
        ),
        close: Some(
            sqlite3_close as unsafe extern "C" fn(*mut sqlite3) -> ::core::ffi::c_int,
        ),
        ...
        errcode: Some(
            sqlite3_errcode as unsafe extern "C" fn(*mut sqlite3) -> ::core::ffi::c_int,
        ),
        errmsg: Some(
            sqlite3_errmsg
                as unsafe extern "C" fn(*mut sqlite3) -> *const ::core::ffi::c_char,
        ),
        errmsg16: Some(
            sqlite3_errmsg16
                as unsafe extern "C" fn(*mut sqlite3) -> *const ::core::ffi::c_void,
        ),
        exec: Some(
            sqlite3_exec
                as unsafe extern "C" fn(
        ...
        result_int64: Some(
            sqlite3_result_int64
                as unsafe extern "C" fn(*mut sqlite3_context, sqlite3_int64) -> (),
        ),
        result_null: Some(
            sqlite3_result_null as unsafe extern "C" fn(*mut sqlite3_context) -> (),
        ),
        result_text: Some(
            sqlite3_result_text
                as unsafe extern "C" fn(
        ...
        step: Some(
            sqlite3_step as unsafe extern "C" fn(*mut sqlite3_stmt) -> ::core::ffi::c_int,
        ),
        ...
        value_int64: Some(
            sqlite3_value_int64
                as unsafe extern "C" fn(*mut sqlite3_value) -> sqlite3_int64,
        ),
        ...
        blob_bytes: Some(
            sqlite3_blob_bytes
                as unsafe extern "C" fn(*mut sqlite3_blob) -> ::core::ffi::c_int,
        ),
        blob_close: Some(
            sqlite3_blob_close
                as unsafe extern "C" fn(*mut sqlite3_blob) -> ::core::ffi::c_int,
        ...
        memory_highwater: Some(
            sqlite3_memory_highwater
                as unsafe extern "C" fn(::core::ffi::c_int) -> sqlite3_int64,
        ),
        memory_used: Some(
            sqlite3_memory_used as unsafe extern "C" fn() -> sqlite3_int64,
        ),
        mutex_alloc: Some(
            sqlite3_mutex_alloc
        ...
        mutex_enter: Some(
            sqlite3_mutex_enter as unsafe extern "C" fn(*mut sqlite3_mutex) -> (),
        ),
        mutex_free: Some(
            sqlite3_mutex_free as unsafe extern "C" fn(*mut sqlite3_mutex) -> (),
        ),
        mutex_leave: Some(
            sqlite3_mutex_leave as unsafe extern "C" fn(*mut sqlite3_mutex) -> (),
        ),
        mutex_try: Some(
            sqlite3_mutex_try
        ...
        vfs_unregister: Some(
            sqlite3_vfs_unregister
                as unsafe extern "C" fn(*mut sqlite3_vfs) -> ::core::ffi::c_int,
        ),
        xthreadsafe: Some(
            sqlite3_threadsafe as unsafe extern "C" fn() -> ::core::ffi::c_int,
        ),
        ...
        context_db_handle: Some(
            sqlite3_context_db_handle
                as unsafe extern "C" fn(*mut sqlite3_context) -> *mut sqlite3,
        ),
        ...
        sql: Some(
            sqlite3_sql
                as unsafe extern "C" fn(*mut sqlite3_stmt) -> *const ::core::ffi::c_char,
        ),
        status: Some(
            sqlite3_status
                as unsafe extern "C" fn(
        ...
        soft_heap_limit64: Some(
            sqlite3_soft_heap_limit64
                as unsafe extern "C" fn(sqlite3_int64) -> sqlite3_int64,
        ),
        sourceid: Some(
            sqlite3_sourceid as unsafe extern "C" fn() -> *const ::core::ffi::c_char,
        ),
        stmt_status: Some(
            sqlite3_stmt_status
                as unsafe extern "C" fn(
        ...
        malloc64: Some(
            sqlite3_malloc64
                as unsafe extern "C" fn(sqlite3_uint64) -> *mut ::core::ffi::c_void,
        ),
        msize: Some(
            sqlite3_msize
                as unsafe extern "C" fn(*mut ::core::ffi::c_void) -> sqlite3_uint64,
        ),
        realloc64: Some(
            sqlite3_realloc64
                as unsafe extern "C" fn(
        ...
        reset_auto_extension: Some(
            sqlite3_reset_auto_extension as unsafe extern "C" fn() -> (),
        ),
        result_blob64: Some(
        ...
        value_dup: Some(
            sqlite3_value_dup
                as unsafe extern "C" fn(*const sqlite3_value) -> *mut sqlite3_value,
        ),
        value_free: Some(
            sqlite3_value_free as unsafe extern "C" fn(*mut sqlite3_value) -> (),
        ),
        ...
        keyword_count: Some(
            sqlite3_keyword_count as unsafe extern "C" fn() -> ::core::ffi::c_int,
        ),
        keyword_name: Some(
        ...
        str_new: Some(
            sqlite3_str_new as unsafe extern "C" fn(*mut sqlite3) -> *mut sqlite3_str,
        ),
        str_finish: Some(
            sqlite3_str_finish
        ...
        str_reset: Some(
            sqlite3_str_reset as unsafe extern "C" fn(*mut sqlite3_str) -> (),
        ),
        str_errcode: Some(
            sqlite3_str_errcode
                as unsafe extern "C" fn(*mut sqlite3_str) -> ::core::ffi::c_int,
        ),
        str_length: Some(
            sqlite3_str_length
                as unsafe extern "C" fn(*mut sqlite3_str) -> ::core::ffi::c_int,
        ...
        free_filename: Some(
            sqlite3_free_filename as unsafe extern "C" fn(sqlite3_filename) -> (),
        ),
        ...
        changes64: Some(
            sqlite3_changes64 as unsafe extern "C" fn(*mut sqlite3) -> sqlite3_int64,
        ),
...
unsafe extern "C" fn sqlite3LoadExtension(
    ...
    unsafe {
        ...
        let mut zErrmsg: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
            ::core::ffi::c_char,
        >();
        let mut zEntry: *const ::core::ffi::c_char = ::core::ptr::null::<
            ::core::ffi::c_char,
        >();
        let mut zAltEntry: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
            ::core::ffi::c_char,
        >();
        let mut aHandle: *mut *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
            *mut ::core::ffi::c_void,
        >();
        ...
        if (*db).flags as ::core::ffi::c_ulonglong
            & SQLITE_LoadExtension as ::core::ffi::c_ulonglong
        ...
        zEntry = if !zProc.is_null() {
            ...
            b"sqlite3_extension_init\0".as_ptr() as *const ::core::ffi::c_char
        };
        if !(nMsg > SQLITE_MAX_PATHLEN as ::core::ffi::c_ulonglong) {
            if !(nMsg == 0 as ::core::ffi::c_ulonglong) {
                ...
                while ii
                    < (::core::mem::size_of::<[*const ::core::ffi::c_char; 1]>()
                        ...
                        ) as ::core::ffi::c_int && handle.is_null()
                {
                    ...
                    if (nMsg as ::core::ffi::c_ulonglong)
                        .wrapping_add(
                            strlen(azEndings[ii as usize]) as ::core::ffi::c_ulonglong,
                        )
                        .wrapping_add(1 as ::core::ffi::c_ulonglong)
                        <= SQLITE_MAX_PATHLEN as ::core::ffi::c_ulonglong
                    {
                ...
                if !handle.is_null() {
                    ...
                    if xInit.is_none() && zProc.is_null() {
                        ...
                        zAltEntry = sqlite3_malloc64(
                            (ncFile + 30 as ::core::ffi::c_int) as sqlite3_uint64,
                        ...
                        memcpy(
                            ...
                            b"sqlite3_\0".as_ptr() as *const ::core::ffi::c_char
                                as *const ::core::ffi::c_void,
                            8 as size_t,
                        );
                        iFile = ncFile - 1 as ::core::ffi::c_int;
                        while iFile >= 0 as ::core::ffi::c_int
                            && !(*zFile.offset(iFile as isize) as ::core::ffi::c_int
                                == '/' as i32)
                        {
                            iFile -= 1;
                        }
                        ...
                        if sqlite3_strnicmp(
                            ...
                            b"lib\0".as_ptr() as *const ::core::ffi::c_char,
                            3 as ::core::ffi::c_int,
                        ) == 0 as ::core::ffi::c_int
                        {
                        ...
                        loop {
                            ...
                            {
                                let c2rust_fresh0 = iEntry;
                                iEntry = iEntry + 1;
                                *zAltEntry.offset(c2rust_fresh0 as isize) = *(&raw const sqlite3UpperToLower
                                    as *const ::core::ffi::c_uchar)
                        ...
                        memcpy(
                            zAltEntry.offset(iEntry as isize)
                                as *mut ::core::ffi::c_void,
                            b"_init\0".as_ptr() as *const ::core::ffi::c_char
                                as *const ::core::ffi::c_void,
                            6 as size_t,
                        );
                        zEntry = zAltEntry;
                    ...
                    if xInit.is_none() {
                        if !pzErrMsg.is_null() {
                            nMsg = (nMsg as ::core::ffi::c_ulonglong)
                                .wrapping_add(
                                    strlen(zEntry).wrapping_add(300 as size_t)
                                        as ::core::ffi::c_ulonglong,
                                ) as u64_0 as u64_0;
                            zErrmsg = sqlite3_malloc64(nMsg as sqlite3_uint64)
                                as *mut ::core::ffi::c_char;
                            *pzErrMsg = zErrmsg;
                            if !zErrmsg.is_null() {
                                sqlite3_snprintf(
                                    ...
                                    zErrmsg,
                                    b"no entry point [%s] in shared library [%s]\0".as_ptr()
                    ...
                    rc = xInit
                        ...
                        )(db, &raw mut zErrmsg, &raw const sqlite3Apis);
                    if rc != 0 {
                    ...
                    aHandle = sqlite3DbMallocZero(
                        ...
                        (::core::mem::size_of::<*mut ::core::ffi::c_void>() as usize)
                            .wrapping_mul(
                                ((*db).nExtension + 1 as ::core::ffi::c_int) as usize,
                            ) as u64_0,
        ...
        if !pzErrMsg.is_null() {
            nMsg = (nMsg as ::core::ffi::c_ulonglong)
                .wrapping_add(300 as ::core::ffi::c_ulonglong) as u64_0 as u64_0;
            zErrmsg = sqlite3_malloc64(nMsg as sqlite3_uint64)
                as *mut ::core::ffi::c_char;
            *pzErrMsg = zErrmsg;
            if !zErrmsg.is_null() {
                sqlite3_snprintf(
                    nMsg as ::core::ffi::c_int,
                    zErrmsg,
                    b"unable to open shared library [%.*s]\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    SQLITE_MAX_PATHLEN,
                    zFile,
                );
...
pub unsafe extern "C" fn sqlite3_enable_load_extension(
    ...
    unsafe {
        ...
        if onoff != 0 {
            ...
            (*db).flags
                &= !((SQLITE_LoadExtension | SQLITE_LoadExtFunc) as u64_0)
                    as ::core::ffi::c_ulonglong;
        }
        sqlite3_mutex_leave((*db).mutex);
        return SQLITE_OK;
    ...
    unsafe {
        ...
        if rc != 0 {
            ...
            if i == sqlite3Autoext.nExt {
                let mut nByte: u64_0 = (sqlite3Autoext.nExt.wrapping_add(1 as u32_0)
                    as usize)
                    .wrapping_mul(
                ...
                if aNew.is_null() {
                    ...
                    let ref mut c2rust_fresh4 = *sqlite3Autoext
                        .aExt
    ...
    unsafe {
        ...
        while i >= 0 as ::core::ffi::c_int {
            if *sqlite3Autoext.aExt.offset(i as isize) == xInit {
                ...
                let ref mut c2rust_fresh3 = *sqlite3Autoext.aExt.offset(i as isize);
                *c2rust_fresh3 = *sqlite3Autoext
                    .aExt
                    .offset(sqlite3Autoext.nExt as isize);
                n += 1;
                break;
