...
extern "C" {
    ...
    fn sqlite3BtreeCopyFile(_: *mut Btree, _: *mut Btree) -> ::core::ffi::c_int;
...
unsafe extern "C" fn execSql(
    ...
    unsafe {
        ...
        loop {
            ...
            let mut zSubSql: *const ::core::ffi::c_char = sqlite3_column_text(
                pStmt,
                0 as ::core::ffi::c_int,
            ...
            if !(!zSubSql.is_null()
                && (strncmp(
                    zSubSql,
                    b"CRE\0".as_ptr() as *const ::core::ffi::c_char,
                    3 as size_t,
                ) == 0 as ::core::ffi::c_int
                    || strncmp(
                        zSubSql,
                        b"INS\0".as_ptr() as *const ::core::ffi::c_char,
                        3 as size_t,
                    ) == 0 as ::core::ffi::c_int))
            {
                continue;
...
pub unsafe extern "C" fn sqlite3Vacuum(
    ...
    unsafe {
        ...
        if !v.is_null() {
            if !((*pParse).nErr != 0) {
                if !pNm.is_null() {
                    iDb = sqlite3TwoPartName(pParse, pNm, pNm, &raw mut pNm);
                    if iDb < 0 as ::core::ffi::c_int {
                        c2rust_current_block = 17230287148795419905;
                    } else {
                        c2rust_current_block = 15427931788582360902;
                    }
                } else {
                    c2rust_current_block = 15427931788582360902;
                }
                match c2rust_current_block {
                    17230287148795419905 => {}
                    _ => {
                        if iDb != 1 as ::core::ffi::c_int {
                            let mut iIntoReg: ::core::ffi::c_int = 0
                                as ::core::ffi::c_int;
                            if !pInto.is_null()
...
pub unsafe extern "C" fn sqlite3RunVacuum(
    ...
    unsafe {
        ...
        let mut pMain: *mut Btree = ::core::ptr::null_mut::<Btree>();
        let mut pTemp: *mut Btree = ::core::ptr::null_mut::<Btree>();
        let mut saved_mDbFlags: u32_0 = 0;
        let mut saved_flags: u64_0 = 0;
        let mut saved_nChange: i64_0 = 0;
        let mut saved_nTotalChange: i64_0 = 0;
        let mut saved_openFlags: u32_0 = 0;
        let mut saved_mTrace: u8_0 = 0;
        ...
        let mut zDbMain: *const ::core::ffi::c_char = ::core::ptr::null::<
            ::core::ffi::c_char,
        >();
        let mut zOut: *const ::core::ffi::c_char = ::core::ptr::null::<
            ::core::ffi::c_char,
        >();
        let mut pgflags: u32_0 = PAGER_SYNCHRONOUS_OFF as u32_0;
        let mut iRandom: u64_0 = 0;
        let mut zDbVacuum: [::core::ffi::c_char; 42] = [0; 42];
        if (*db).autoCommit == 0 {
            sqlite3SetString(
                pzErrMsg,
                db,
                b"cannot VACUUM from within a transaction\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
            return SQLITE_ERROR;
        }
        if (*db).nVdbeActive > 1 as ::core::ffi::c_int {
            sqlite3SetString(
                pzErrMsg,
                db,
                b"cannot VACUUM - SQL statements in progress\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
            return SQLITE_ERROR;
        }
        saved_openFlags = (*db).openFlags as u32_0;
        if !pOut.is_null() {
            if sqlite3_value_type(pOut) != SQLITE_TEXT {
                sqlite3SetString(
                    pzErrMsg,
                    db,
                    b"non-text filename\0".as_ptr() as *const ::core::ffi::c_char,
                );
                return SQLITE_ERROR;
            }
            zOut = sqlite3_value_text(pOut) as *const ::core::ffi::c_char;
            (*db).openFlags &= !SQLITE_OPEN_READONLY as ::core::ffi::c_uint;
            (*db).openFlags
                |= (SQLITE_OPEN_CREATE | SQLITE_OPEN_READWRITE) as ::core::ffi::c_uint;
        } else {
            zOut = b"\0".as_ptr() as *const ::core::ffi::c_char;
        }
        ...
        (*db).flags
            |= ((SQLITE_WriteSchema | SQLITE_IgnoreChecks) as u64_0 | SQLITE_Comments
                | SQLITE_AttachCreate | SQLITE_AttachWrite) as ::core::ffi::c_ulonglong;
        (*db).mDbFlags = ((*db).mDbFlags as ::core::ffi::c_uint
            | (DBFLAG_PreferBuiltin | DBFLAG_Vacuum) as ::core::ffi::c_uint) as u32_0;
        (*db).flags
            &= !((SQLITE_ForeignKeys | SQLITE_ReverseOrder | SQLITE_Defensive) as u64_0
                | SQLITE_CountRows) as ::core::ffi::c_ulonglong;
        (*db).mTrace = 0 as u8_0;
        zDbMain = (*(*db).aDb.offset(iDb as isize)).zDbSName;
        pMain = (*(*db).aDb.offset(iDb as isize)).pBt;
        isMemDb = sqlite3PagerIsMemdb(sqlite3BtreePager(pMain) as *mut Pager);
        sqlite3_randomness(
        ...
        sqlite3_snprintf(
            ...
            b"vacuum_%016llx\0".as_ptr() as *const ::core::ffi::c_char,
            iRandom,
        );
        nDb = (*db).nDb;
        rc = execSqlF(
            db,
            pzErrMsg,
            b"ATTACH %Q AS %s\0".as_ptr() as *const ::core::ffi::c_char,
            zOut,
            &raw mut zDbVacuum as *mut ::core::ffi::c_char,
        );
        (*db).openFlags = saved_openFlags as ::core::ffi::c_uint;
        if !(rc != SQLITE_OK) {
            pDb = (*db).aDb.offset(nDb as isize) as *mut Db;
            pTemp = (*pDb).pBt;
            if !pOut.is_null() {
                let mut id: *mut sqlite3_file = sqlite3PagerFile(
                    sqlite3BtreePager(pTemp) as *mut Pager,
                );
                let mut sz: i64_0 = 0 as i64_0;
                if !(*id).pMethods.is_null()
                    && (sqlite3OsFileSize(id, &raw mut sz) != SQLITE_OK
                        || sz > 0 as ::core::ffi::c_longlong)
                {
                    rc = SQLITE_ERROR;
                    sqlite3SetString(
                        pzErrMsg,
                        db,
                        b"output file already exists\0".as_ptr()
                            as *const ::core::ffi::c_char,
                    );
                    c2rust_current_block = 6504007097832071157;
                } else {
                    (*db).mDbFlags = ((*db).mDbFlags as ::core::ffi::c_uint
                        | DBFLAG_VacuumInto as ::core::ffi::c_uint) as u32_0;
                    pgflags = ((*(*db).aDb.offset(iDb as isize)).safety_level
                        as ::core::ffi::c_ulonglong
                        | (*db).flags as ::core::ffi::c_ulonglong
                            & PAGER_FLAGS_MASK as ::core::ffi::c_ulonglong) as u32_0;
                    c2rust_current_block = 6450597802325118133;
                }
            } else {
                c2rust_current_block = 6450597802325118133;
            }
            match c2rust_current_block {
                ...
                _ => {
                    ...
                    sqlite3BtreeSetSpillSize(
                        pTemp,
                        sqlite3BtreeSetSpillSize(pMain, 0 as ::core::ffi::c_int),
                    );
                    sqlite3BtreeSetPagerFlags(
                        pTemp,
                        pgflags as ::core::ffi::c_uint
                            | PAGER_CACHESPILL as ::core::ffi::c_uint,
                    );
                    rc = execSql(
                        db,
                        pzErrMsg,
                    ...
                    if !(rc != SQLITE_OK) {
                        ...
                        if !(rc != SQLITE_OK) {
                            if sqlite3PagerGetJournalMode(
                                sqlite3BtreePager(pMain) as *mut Pager,
                            ) == PAGER_JOURNALMODE_WAL && pOut.is_null()
                            {
                                (*db).nextPagesize = 0 as ::core::ffi::c_int;
                            }
                            if sqlite3BtreeSetPageSize(
                                pTemp,
                                    ...
                                    ) != 0 || (*db).mallocFailed as ::core::ffi::c_int != 0
                            {
                                ...
                                if !(rc != SQLITE_OK) {
                                    ...
                                    if !(rc != SQLITE_OK) {
                                        ...
                                        (*db).mDbFlags = ((*db).mDbFlags as ::core::ffi::c_uint
                                            & !DBFLAG_Vacuum as ::core::ffi::c_uint) as u32_0;
                                        if !(rc != SQLITE_OK) {
                                            rc = execSqlF(
                                                db,
                                                pzErrMsg,
                                            ...
                                            if !(rc != 0) {
                                                let mut meta: u32_0 = 0;
                                                let mut i: ::core::ffi::c_int = 0;
                                                static mut aCopy: [::core::ffi::c_uchar; 10] = [
                                                    BTREE_SCHEMA_VERSION as ::core::ffi::c_uchar,
                                                    1 as ::core::ffi::c_int as ::core::ffi::c_uchar,
                                                    BTREE_DEFAULT_CACHE_SIZE as ::core::ffi::c_uchar,
                                                    0 as ::core::ffi::c_int as ::core::ffi::c_uchar,
                                                    BTREE_TEXT_ENCODING as ::core::ffi::c_uchar,
                                                    0 as ::core::ffi::c_int as ::core::ffi::c_uchar,
                                                    BTREE_USER_VERSION as ::core::ffi::c_uchar,
                                                    0 as ::core::ffi::c_int as ::core::ffi::c_uchar,
                                                    BTREE_APPLICATION_ID as ::core::ffi::c_uchar,
                                                    0 as ::core::ffi::c_int as ::core::ffi::c_uchar,
                                                ];
                                                i = 0 as ::core::ffi::c_int;
                                                loop {
                                                    if !(i
                                                        < (::core::mem::size_of::<[::core::ffi::c_uchar; 10]>()
                                                            as usize)
                                                            .wrapping_div(
                                                                ::core::mem::size_of::<::core::ffi::c_uchar>() as usize,
                                                            ) as ::core::ffi::c_int)
                                                    {
                                                    ...
                                                    rc = sqlite3BtreeUpdateMeta(
                                                        ...
                                                        meta
                                                            .wrapping_add(
                                                                aCopy[(i + 1 as ::core::ffi::c_int) as usize] as u32_0,
                                                            ),
                                                    );
