...
unsafe extern "C" fn lockBtreeMutex(mut p: *mut Btree) {
    unsafe {
...
#[inline(never)]
unsafe extern "C" fn unlockBtreeMutex(mut p: *mut Btree) {
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3BtreeEnter(mut p: *mut Btree) {
    unsafe {
        if (*p).sharable == 0 {
            return;
        }
...
#[inline(never)]
unsafe extern "C" fn btreeLockCarefully(mut p: *mut Btree) {
    unsafe {
        let mut pLater: *mut Btree = ::core::ptr::null_mut::<Btree>();
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3BtreeLeave(mut p: *mut Btree) {
    unsafe {
        if (*p).sharable != 0 {
            (*p).wantToLock -= 1;
...
#[inline(never)]
unsafe extern "C" fn btreeEnterAll(mut db: *mut sqlite3) {
    unsafe {
        let mut i: ::core::ffi::c_int = 0;
        let mut skipOk: u8_0 = 1 as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3BtreeEnterAll(mut db: *mut sqlite3) {
    unsafe {
...
#[inline(never)]
unsafe extern "C" fn btreeLeaveAll(mut db: *mut sqlite3) {
    unsafe {
        let mut i: ::core::ffi::c_int = 0;
        let mut p: *mut Btree = ::core::ptr::null_mut::<Btree>();
        i = 0 as ::core::ffi::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3BtreeLeaveAll(mut db: *mut sqlite3) {
    unsafe {
        if (*db).noSharedCache as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            btreeLeaveAll(db);
        }
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3BtreeEnterCursor(mut pCur: *mut BtCursor) {
    unsafe {
        sqlite3BtreeEnter((*pCur).pBtree);
    }
}
#[no_mangle]
pub unsafe extern "C" fn sqlite3BtreeLeaveCursor(mut pCur: *mut BtCursor) {
    unsafe {
