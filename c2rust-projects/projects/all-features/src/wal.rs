                ...
                s1 = (s1 as ::core::ffi::c_uint)
                    .wrapping_add(
                        ((*aData.offset(0 as ::core::ffi::c_int as isize)
                            ...
                            .wrapping_add(
                                (*aData.offset(0 as ::core::ffi::c_int as isize)
                                    & 0xff0000 as u32_0) >> 8 as ::core::ffi::c_int,
                            )
                            .wrapping_add(
                                (*aData.offset(0 as ::core::ffi::c_int as isize)
...
unsafe extern "C" fn walHash(mut iPage: u32_0) -> ::core::ffi::c_int {
    unsafe {
        return (iPage.wrapping_mul(HASHTABLE_HASH_1 as u32_0)
            & (HASHTABLE_NSLOT - 1 as ::core::ffi::c_int) as u32_0)
            as ::core::ffi::c_int;
    }
}
...
unsafe extern "C" fn walFramePage(mut iFrame: u32_0) -> ::core::ffi::c_int {
    unsafe {
        let mut iHash: ::core::ffi::c_int = (iFrame
            .wrapping_add(HASHTABLE_NPAGE as u32_0) as usize)
        ...
        if !(rc != SQLITE_OK) {
            if nSize > WAL_HDRSIZE as ::core::ffi::c_longlong {
                ...
                if rc != SQLITE_OK {
                    ...
                    {
                        c2rust_current_block = 10970091838192988906;
                    } else {
                                                    ...
                                                    HASHTABLE_NPAGE_ONE
                                                        .wrapping_add(
                                                            iPg
                                                                ...
                                                                .wrapping_mul(HASHTABLE_NPAGE as u32_0) as usize,
                                                        )
                                                }),
                                            ) as u32_0;
                                ...
                                == walIteratorNext(pIter, &raw mut iDbpage, &raw mut iFrame)
                        {
                            ...
                            if (*db).u1.isInterrupted != 0
                            {
                                ...
                                iOffset = (WAL_HDRSIZE as ::core::ffi::c_longlong
                                    + iFrame.wrapping_sub(1 as u32_0) as ::core::ffi::c_longlong
                                ...
                                iOffset = iDbpage.wrapping_sub(1 as u32_0) as i64_0
                                    * szPage as i64_0;
                                rc = sqlite3OsWrite(
                                    (*pWal).pDbFd,
                        ...
                        *pChanged = 1 as ::core::ffi::c_int;
                        ...
                        if !(rc != SQLITE_OK) {
                            ...
                            ) != 0
                            {
                                ...
                                szFrame = (*pWal)
                                    .szPage
                                    .wrapping_add(WAL_FRAME_HDRSIZE as u32_0)
                                    as ::core::ffi::c_int;
...
pub unsafe extern "C" fn sqlite3WalReadFrame(
    ...
    unsafe {
        ...
        iOffset = (WAL_HDRSIZE as ::core::ffi::c_longlong
            + iRead.wrapping_sub(1 as u32_0) as ::core::ffi::c_longlong
    ...
    unsafe {
        ...
        if (*pWal).iReCksum == 1 as u32_0 {
            ...
            iCksumOff = (WAL_HDRSIZE as ::core::ffi::c_longlong
                + (*pWal).iReCksum.wrapping_sub(1 as u32_0).wrapping_sub(1 as u32_0)
        ...
        while rc == SQLITE_OK && iRead <= iLast {
            let mut iOff: i64_0 = WAL_HDRSIZE as i64_0
                + iRead.wrapping_sub(1 as u32_0) as i64_0
                    * (szPage + WAL_FRAME_HDRSIZE) as i64_0;
            rc = sqlite3OsRead(
                (*pWal).pWalFd,
                aBuf as *mut ::core::ffi::c_void,
