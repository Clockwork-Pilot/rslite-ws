...
unsafe extern "C" fn sqlite3_get_table_cb(
    ...
    unsafe {
        ...
        let mut z: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
            ::core::ffi::c_char,
        >();
        if (*p).nRow == 0 as u32_0 && !argv.is_null() {
            need = nCol * 2 as ::core::ffi::c_int;
        } else {
            need = nCol;
        }
        if (*p).nData.wrapping_add(need as u32_0) > (*p).nAlloc {
            ...
            if azNew.is_null() {
                c2rust_current_block = 2358688204319475966;
            } else {
                (*p).azResult = azNew;
    ...
    unsafe {
        ...
        *c2rust_fresh0 = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        let ref mut c2rust_fresh1 = *res
            .azResult
            .offset(0 as ::core::ffi::c_int as isize);
        *c2rust_fresh1 = res.nData as intptr_t as *mut ::core::ffi::c_void
            as *mut ::core::ffi::c_char;
...
pub unsafe extern "C" fn sqlite3_free_table(
    ...
    unsafe {
        if !azResult.is_null() {
            ...
            n = *azResult.offset(0 as ::core::ffi::c_int as isize) as intptr_t
                as ::core::ffi::c_int;
