...
unsafe extern "C" fn explainIndexRange(
    ...
    unsafe {
        ...
        if nEq as ::core::ffi::c_int == 0 as ::core::ffi::c_int
            && (*pLoop).wsFlags & (WHERE_BTM_LIMIT | WHERE_TOP_LIMIT) as u32_0
                == 0 as u32_0
        {
            return;
        }
...
pub unsafe extern "C" fn sqlite3WhereAddExplainText(
    ...
    unsafe {
            ...
            .explain as ::core::ffi::c_int == 2 as ::core::ffi::c_int || false
        {
            ...
            flags = (*pLoop).wsFlags;
            isSearch = (flags & (WHERE_BTM_LIMIT | WHERE_TOP_LIMIT) as u32_0
                != 0 as u32_0
...
unsafe extern "C" fn codeINTerm(
    ...
    unsafe {
        ...
        (*pLoop).wsFlags = ((*pLoop).wsFlags as ::core::ffi::c_uint
            | WHERE_IN_ABLE as ::core::ffi::c_uint) as u32_0;
        ...
        {
            (*pLoop).wsFlags = ((*pLoop).wsFlags as ::core::ffi::c_uint
                | WHERE_IN_EARLYOUT as ::core::ffi::c_uint) as u32_0;
        }
        i = (*pLevel).u.in_0.nIn;
        ...
        if !pIn.is_null() {
            ...
            if iEq > 0 as ::core::ffi::c_int
                && (*pLoop).wsFlags & (WHERE_IN_SEEKSCAN | WHERE_VIRTUALTABLE) as u32_0
                    == 0 as u32_0
            {
                sqlite3VdbeAddOp3(
                    v,
...
pub unsafe extern "C" fn sqlite3WhereCodeOneLoopStart(
    ...
    unsafe {
        ...
        if (*pTabItem).fg.viaCoroutine() != 0 {
            ...
            while j < nConstraint {
                        ...
                        & 1 as ::core::ffi::c_int != 0
                {
                    ...
                    && (if j <= 31 as ::core::ffi::c_int {
                        ...
                        0 as u32_0
                    }) & (*pLoop).u.vtab.mHandleIn == 0 as u32_0
                    && (*db).mallocFailed == 0
                {
            ...
            && (*pLoop).wsFlags & (WHERE_COLUMN_IN | WHERE_COLUMN_EQ) as u32_0
                != 0 as u32_0
        {
            ...
            && (*pLoop).wsFlags & WHERE_COLUMN_RANGE as u32_0 != 0 as u32_0
        {
            ...
            if (*pLoop).wsFlags & WHERE_TOP_LIMIT as u32_0 != 0 {
                    ...
                    != 0 as ::core::ffi::c_int
                {
                    ...
                    (*pLevel).iLikeRepCntr = ((*pLevel).iLikeRepCntr
                        as ::core::ffi::c_uint
                        | (bRev
                            ^ (*(*pIdx).aSortOrder.offset(nEq as isize)
                                as ::core::ffi::c_int == SQLITE_SO_DESC)
                                as ::core::ffi::c_int) as ::core::ffi::c_uint) as u32_0;
                }
            ...
            if (*pLoop).wsFlags & (WHERE_TOP_LIMIT | WHERE_BTM_LIMIT) as u32_0
                == 0 as u32_0
                ...
                && nConstraint_0 == (*pLoop).nSkip as ::core::ffi::c_int)
            {
                ...
                op_0 = aStartOp[((start_constraints << 2 as ::core::ffi::c_int)
                    ...
                    as ::core::ffi::c_int;
                if (*pLoop).wsFlags & WHERE_IN_SEEKSCAN as u32_0 != 0 as u32_0
                    && op_0 == OP_SeekGE
                {
                ...
                while iTerm < (*pWC).nTerm {
                    ...
                    if !((*pWC).a.offset(iTerm as isize) as *mut WhereTerm == pTerm) {
                            ...
                            != 0 as ::core::ffi::c_int)
                        {
                            ...
                            {
                                if !((*pExpr).flags
                                    & 0x400000 as ::core::ffi::c_int as u32_0 != 0 as u32_0)
                                {
        ...
        if (*pLevel).iLeftJoin != 0 {
            ...
            if (*pLevel).pRJ.is_null() {
                c2rust_current_block = 17789631498781795007;
            } else {
