                ...
                && zTab.is_null()
            {
                ...
                while j < (*pEList).nExpr {
                        ...
                        && sqlite3_stricmp(zAs, zCol) == 0 as ::core::ffi::c_int
                    {
                        ...
                        c2rust_current_block = 11358125725991724558;
                        break 's_125;
                    } else {
                        j += 1;
                    }
                    ...
                    _ => {
                        if !((*pExpr).flags
                            & (0x10000 as ::core::ffi::c_int
                                | 0x800000 as ::core::ffi::c_int) as u32_0 != 0 as u32_0)
                        {
                            sqlite3ExprDelete(db, (*pExpr).pLeft);
                            (*pExpr).pLeft = ::core::ptr::null_mut::<Expr>();
                            sqlite3ExprDelete(db, (*pExpr).pRight);
        ...
        match (*pExpr).op as ::core::ffi::c_int {
            ...
            TK_FUNCTION => {
                ...
                if pDef.is_null() {
                    ...
                    if (*pDef).funcFlags & SQLITE_SUBTYPE as u32_0 != 0
                        || (*pExpr).flags & 0x80000000 as ::core::ffi::c_uint as u32_0
                            != 0 as u32_0
                    {
                        ...
                        while ii < n {
                            let ref mut c2rust_fresh1 = (*(*(&raw mut (*pList).a
                                ...
                                .pExpr)
                                .flags;
                            *c2rust_fresh1 = (*c2rust_fresh1 as ::core::ffi::c_uint
                    ...
                    if (*pDef).funcFlags
                        & (SQLITE_FUNC_CONSTANT | SQLITE_FUNC_SLOCHNG) as u32_0 != 0
                    {
                        (*pExpr).flags = ((*pExpr).flags as ::core::ffi::c_uint
                    ...
                    if (*pDef).funcFlags & SQLITE_FUNC_INTERNAL as u32_0 != 0 as u32_0
                        && (*pParse).nested as ::core::ffi::c_int
                            == 0 as ::core::ffi::c_int
                        && (*(*pParse).db).mDbFlags & DBFLAG_InternalFunc as u32_0
                            == 0 as u32_0
                    {
                        no_such_func = 1 as ::core::ffi::c_int;
                        pDef = ::core::ptr::null_mut::<FuncDef>();
                    } else if (*pDef).funcFlags
                        & (SQLITE_FUNC_DIRECT | SQLITE_FUNC_UNSAFE) as u32_0
                        != 0 as u32_0
                        ...
                        as ::core::ffi::c_int
                {
                            ...
                            && (*pNC).ncFlags & NC_AllowWin == 0 as ::core::ffi::c_int
                    {
                        let mut zType: *const ::core::ffi::c_char = ::core::ptr::null::<
                            ::core::ffi::c_char,
                        >();
                        if (*pDef).funcFlags & SQLITE_FUNC_WINDOW as u32_0 != 0
                            || !pWin.is_null()
                        {
                    ...
                    != 0 as u32_0 || !(*pExpr).pLeft.is_null()
                {
            ...
            TK_EXISTS | TK_SELECT | TK_IN => {
                if (*pExpr).flags & EP_xIsSelect as u32_0 != 0 as u32_0 {
                    ...
                    if nRef != (*pNC).nRef {
                        (*pExpr).flags = ((*pExpr).flags as ::core::ffi::c_uint
                            | 0x40 as ::core::ffi::c_int as u32_0 as ::core::ffi::c_uint)
                            as u32_0;
                        (*(*pExpr).x.pSelect).selFlags = ((*(*pExpr).x.pSelect).selFlags
                            as ::core::ffi::c_uint
                            | SF_Correlated as ::core::ffi::c_uint) as u32_0;
                    }
    ...
    unsafe {
        ...
        while !p.is_null() {
            (*p).selFlags = ((*p).selFlags as ::core::ffi::c_uint
                | SF_Resolved as ::core::ffi::c_uint) as u32_0;
            memset(
            ...
            while i < (*(*p).pSrc).nSrc {
                ...
                if (*pItem).fg.isSubquery() as ::core::ffi::c_int != 0
                    && (*(*(*pItem).u4.pSubq).pSelect).selFlags & SF_Resolved as u32_0
                        == 0 as u32_0
                {
