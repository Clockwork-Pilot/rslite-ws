...
pub const BITVEC_USIZE: usize = (BITVEC_SZ as usize)
    .wrapping_sub((3 as usize).wrapping_mul(::core::mem::size_of::<u32_0>() as usize))
...
pub const BITVEC_NPTR: u32_0 = BITVEC_USIZE
    .wrapping_div(::core::mem::size_of::<*mut Bitvec>() as usize) as u32_0;
#[no_mangle]
pub unsafe extern "C" fn sqlite3BitvecCreate(mut iSize: u32_0) -> *mut Bitvec {
    unsafe {
        let mut p: *mut Bitvec = ::core::ptr::null_mut::<Bitvec>();
        p = sqlite3MallocZero(::core::mem::size_of::<Bitvec>() as u64_0) as *mut Bitvec;
        if !p.is_null() {
            (*p).iSize = iSize;
        }
        return p;
...
pub unsafe extern "C" fn sqlite3BitvecTestNotNull(
    ...
    unsafe {
        ...
        if (*p).iSize as usize <= BITVEC_NBIT {
            return ((*p).u.aBitmap[i.wrapping_div(BITVEC_SZELEM as u32_0) as usize]
                as ::core::ffi::c_int
                & (1 as ::core::ffi::c_int)
                    << (i & (BITVEC_SZELEM - 1 as ::core::ffi::c_int) as u32_0)
                != 0 as ::core::ffi::c_int) as ::core::ffi::c_int
        } else {
            let c2rust_fresh0 = i;
            i = i.wrapping_add(1);
            let mut h: u32_0 = (c2rust_fresh0.wrapping_mul(1 as u32_0) as usize)
                .wrapping_rem(BITVEC_NINT) as u32_0;
            while (*p).u.aHash[h as usize] != 0 {
                if (*p).u.aHash[h as usize] == i {
                    return 1 as ::core::ffi::c_int;
                }
                h = (h.wrapping_add(1 as u32_0) as usize).wrapping_rem(BITVEC_NINT)
                    as u32_0;
            }
            return 0 as ::core::ffi::c_int;
        };
...
pub unsafe extern "C" fn sqlite3BitvecTest(
    ...
    unsafe {
        return (!p.is_null() && sqlite3BitvecTestNotNull(p, i) != 0)
            as ::core::ffi::c_int;
    }
}
#[no_mangle]
pub unsafe extern "C" fn sqlite3BitvecSet(
    ...
    unsafe {
        ...
        if (*p).iSize as usize <= BITVEC_NBIT {
            (*p).u.aBitmap[i.wrapping_div(BITVEC_SZELEM as u32_0) as usize] = ((*p)
                .u
                .aBitmap[i.wrapping_div(BITVEC_SZELEM as u32_0) as usize]
                as ::core::ffi::c_int
                | (1 as ::core::ffi::c_int)
                    << (i & (BITVEC_SZELEM - 1 as ::core::ffi::c_int) as u32_0)) as u8_0;
            return SQLITE_OK;
        }
        let c2rust_fresh1 = i;
        i = i.wrapping_add(1);
        h = (c2rust_fresh1.wrapping_mul(1 as u32_0) as usize).wrapping_rem(BITVEC_NINT)
            as u32_0;
        if (*p).u.aHash[h as usize] == 0 {
            if ((*p).nSet as usize) < BITVEC_NINT.wrapping_sub(1 as usize) {
                c2rust_current_block = 995158087890868247;
            } else {
                c2rust_current_block = 16690998701828906459;
            }
        } else {
            loop {
                if (*p).u.aHash[h as usize] == i {
        ...
        match c2rust_current_block {
            16690998701828906459 => {
                if (*p).nSet as usize >= BITVEC_MXHASH {
                    let mut j: ::core::ffi::c_uint = 0;
                    let mut rc: ::core::ffi::c_int = 0;
                    let mut aiValues: *mut u32_0 = sqlite3DbMallocRaw(
                        ::core::ptr::null_mut::<sqlite3>(),
                        ::core::mem::size_of::<[u32_0; 124]>() as u64_0,
                    ) as *mut u32_0;
                    if aiValues.is_null() {
                        return SQLITE_NOMEM_BKPT
                    } else {
                        memcpy(
                            ...
                            &raw mut (*p).u.aHash as *mut u32_0
                                as *const ::core::ffi::c_void,
                            ::core::mem::size_of::<[u32_0; 124]>() as size_t,
                        );
                        memset(
                            &raw mut (*p).u.apSub as *mut *mut Bitvec
                                as *mut ::core::ffi::c_void,
                            0 as ::core::ffi::c_int,
                            ::core::mem::size_of::<[*mut Bitvec; 62]>() as size_t,
                        );
                        (*p).iDivisor = (*p).iSize.wrapping_div(BITVEC_NPTR);
                        if (*p).iSize.wrapping_rem(BITVEC_NPTR) != 0 as u32_0 {
                            (*p).iDivisor = (*p).iDivisor.wrapping_add(1);
                        }
                        if ((*p).iDivisor as usize) < BITVEC_NBIT {
                            (*p).iDivisor = BITVEC_NBIT as u32_0;
                        }
...
pub unsafe extern "C" fn sqlite3BitvecClear(
    ...
    unsafe {
        ...
        if (*p).iSize as usize <= BITVEC_NBIT {
            ...
            memcpy(
                aiValues as *mut ::core::ffi::c_void,
                &raw mut (*p).u.aHash as *mut u32_0 as *const ::core::ffi::c_void,
                ::core::mem::size_of::<[u32_0; 124]>() as size_t,
            );
            memset(
                &raw mut (*p).u.aHash as *mut u32_0 as *mut ::core::ffi::c_void,
                0 as ::core::ffi::c_int,
                ::core::mem::size_of::<[u32_0; 124]>() as size_t,
            );
            (*p).nSet = 0 as u32_0;
            ...
            while (j as usize) < BITVEC_NINT {
                if *aiValues.offset(j as isize) != 0
                    && *aiValues.offset(j as isize) != i.wrapping_add(1 as u32_0)
                {
                    let mut h: u32_0 = ((*aiValues.offset(j as isize))
                        .wrapping_sub(1 as u32_0)
                        .wrapping_mul(1 as u32_0) as usize)
                        .wrapping_rem(BITVEC_NINT) as u32_0;
                    (*p).nSet = (*p).nSet.wrapping_add(1);
                    while (*p).u.aHash[h as usize] != 0 {
                        h = h.wrapping_add(1);
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3BitvecSize(mut p: *mut Bitvec) -> u32_0 {
    unsafe {
        return (*p).iSize;
    }
}
...
pub unsafe extern "C" fn sqlite3BitvecBuiltinTest(
    ...
    unsafe {
        ...
        let mut pV: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<
            ::core::ffi::c_uchar,
        >();
        ...
        let mut pTmpSpace: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
            ::core::ffi::c_void,
        >();
        if sz <= 0 as ::core::ffi::c_int {
            pBitvec = sqlite3BitvecCreate((2 as u32_0).wrapping_mul(-sz as u32_0));
            pV = ::core::ptr::null_mut::<::core::ffi::c_uchar>();
        } else {
            pBitvec = sqlite3BitvecCreate(sz as u32_0);
            pV = sqlite3MallocZero(
                ((7 as ::core::ffi::c_longlong + sz as ::core::ffi::c_longlong)
                    / 8 as ::core::ffi::c_longlong + 1 as ::core::ffi::c_longlong)
                    as u64_0,
            ) as *mut ::core::ffi::c_uchar;
        }
        pTmpSpace = sqlite3_malloc64(BITVEC_SZ as sqlite3_uint64);
        if !(pBitvec.is_null() || pTmpSpace.is_null()
            || pV.is_null() && sz > 0 as ::core::ffi::c_int)
        {
            sqlite3BitvecSet(::core::ptr::null_mut::<Bitvec>(), 1 as u32_0);
            sqlite3BitvecClear(::core::ptr::null_mut::<Bitvec>(), 1 as u32_0, pTmpSpace);
            i = 0 as ::core::ffi::c_int;
            pc = i;
            loop {
                op = *aOp.offset(pc as isize);
                if !(op != 0 as ::core::ffi::c_int) {
                    c2rust_current_block = 3275366147856559585;
                    break;
                }
                if op >= 6 as ::core::ffi::c_int {
                    ...
                    let ref mut c2rust_fresh2 = *aOp
                        .offset((pc + 1 as ::core::ffi::c_int) as isize);
                    *c2rust_fresh2 -= 1;
                    ...
                    if op & 1 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                        if !pV.is_null() {
                            let ref mut c2rust_fresh3 = *pV
                                .offset(
                                    (i + 1 as ::core::ffi::c_int >> 3 as ::core::ffi::c_int)
                                        as isize,
                                );
                        ...
                        {
                            c2rust_current_block = 8101446589479056943;
                            break;
                        }
                    } else {
                        if !pV.is_null() {
                            let ref mut c2rust_fresh4 = *pV
                                .offset(
                                    (i + 1 as ::core::ffi::c_int >> 3 as ::core::ffi::c_int)
                                        as isize,
                                );
            ...
            match c2rust_current_block {
                ...
                _ => {
                    if !pV.is_null() {
                        rc = ((sqlite3BitvecTest(
                            ::core::ptr::null_mut::<Bitvec>(),
                            0 as u32_0,
                        )
                            + sqlite3BitvecTest(
                                pBitvec,
                                (sz + 1 as ::core::ffi::c_int) as u32_0,
                            ) + sqlite3BitvecTest(pBitvec, 0 as u32_0)) as u32_0)
                            .wrapping_add(
                                sqlite3BitvecSize(pBitvec).wrapping_sub(sz as u32_0),
                            ) as ::core::ffi::c_int;
                        ...
                        while i <= sz {
                            if (*pV.offset((i >> 3 as ::core::ffi::c_int) as isize)
                                ...
                                != 0 as ::core::ffi::c_int) as ::core::ffi::c_int
                                != sqlite3BitvecTest(pBitvec, i as u32_0)
                            {
                                rc = i;
                                break;
                            } else {
        ...
        sqlite3_free(pV as *mut ::core::ffi::c_void);
