...
pub const ROWSET_ENTRY_PER_CHUNK: usize = ((ROWSET_ALLOCATION_SIZE
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3RowSetInit(mut db: *mut sqlite3) -> *mut RowSet {
    unsafe {
        let mut p: *mut RowSet = sqlite3DbMallocRawNN(
            db,
            ::core::mem::size_of::<RowSet>() as u64_0,
        ) as *mut RowSet;
        if !p.is_null() {
            let mut N: ::core::ffi::c_int = sqlite3DbMallocSize(
                db,
            ...
            (*p).pFresh = (p as *mut ::core::ffi::c_char)
                .offset(
            ...
            (*p).nFresh = (N as usize)
                ...
                .wrapping_div(::core::mem::size_of::<RowSetEntry>() as usize) as u16_0;
            (*p).rsFlags = ROWSET_SORTED as u16_0;
...
pub unsafe extern "C" fn sqlite3RowSetClear(mut pArg: *mut ::core::ffi::c_void) {
    unsafe {
        ...
        while !pChunk.is_null() {
            ...
            sqlite3DbFree((*p).db, pChunk as *mut ::core::ffi::c_void);
            pChunk = pNextChunk;
        }
        (*p).pChunk = ::core::ptr::null_mut::<RowSetChunk>();
        (*p).nFresh = 0 as u16_0;
...
pub unsafe extern "C" fn sqlite3RowSetDelete(mut pArg: *mut ::core::ffi::c_void) {
    unsafe {
        ...
        sqlite3DbFree((*(pArg as *mut RowSet)).db, pArg);
    }
}
    ...
    unsafe {
        if (*p).nFresh as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            ...
            pNew = sqlite3DbMallocRawNN(
                (*p).db,
                ::core::mem::size_of::<RowSetChunk>() as u64_0,
            ) as *mut RowSetChunk;
            if pNew.is_null() {
            ...
            (*p).nFresh = ROWSET_ENTRY_PER_CHUNK as u16_0;
        }
        (*p).nFresh = (*p).nFresh.wrapping_sub(1);
        let c2rust_fresh0 = (*p).pFresh;
        (*p).pFresh = (*p).pFresh.offset(1);
        return c2rust_fresh0;
    }
}
#[no_mangle]
pub unsafe extern "C" fn sqlite3RowSetInsert(mut p: *mut RowSet, mut rowid: i64_0) {
    unsafe {
        ...
        if !pLast.is_null() {
            if rowid <= (*pLast).v {
                (*p).rsFlags = ((*p).rsFlags as ::core::ffi::c_int & !ROWSET_SORTED)
                    as u16_0;
            }
            (*pLast).pRight = pEntry;
        } else {
...
unsafe extern "C" fn rowSetEntrySort(mut pIn: *mut RowSetEntry) -> *mut RowSetEntry {
    unsafe {
        ...
        let mut aBucket: [*mut RowSetEntry; 40] = [::core::ptr::null_mut::<
            RowSetEntry,
        >(); 40];
        memset(
            &raw mut aBucket as *mut *mut RowSetEntry as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<[*mut RowSetEntry; 40]>() as size_t,
        );
        while !pIn.is_null() {
            pNext = (*pIn).pRight;
...
pub unsafe extern "C" fn sqlite3RowSetNext(
    mut p: *mut RowSet,
    mut pRowid: *mut i64_0,
) -> ::core::ffi::c_int {
    unsafe {
        if (*p).rsFlags as ::core::ffi::c_int & ROWSET_NEXT == 0 as ::core::ffi::c_int {
            if (*p).rsFlags as ::core::ffi::c_int & ROWSET_SORTED
                == 0 as ::core::ffi::c_int
            {
                (*p).pEntry = rowSetEntrySort((*p).pEntry);
            }
            (*p).rsFlags = ((*p).rsFlags as ::core::ffi::c_int
                | (ROWSET_SORTED | ROWSET_NEXT)) as u16_0;
        }
        if !(*p).pEntry.is_null() {
            *pRowid = (*(*p).pEntry).v;
    ...
    unsafe {
        ...
        if iBatch != (*pRowSet).iBatch {
            ...
            if !p.is_null() {
                ...
                if (*pRowSet).rsFlags as ::core::ffi::c_int & ROWSET_SORTED
                    == 0 as ::core::ffi::c_int
                {
                    p = rowSetEntrySort(p);
                }
                ...
                while !pTree.is_null() {
                    ...
                    if (*pTree).pLeft.is_null() {
                        ...
                        let mut pAux: *mut RowSetEntry = ::core::ptr::null_mut::<
                            RowSetEntry,
                        >();
                        let mut pTail: *mut RowSetEntry = ::core::ptr::null_mut::<
                            RowSetEntry,
                        >();
                ...
                (*pRowSet).rsFlags = ((*pRowSet).rsFlags as ::core::ffi::c_int
                    | ROWSET_SORTED) as u16_0;
            }
