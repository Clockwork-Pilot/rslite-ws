...
pub unsafe extern "C" fn sqlite3AppendOneUtf8Character(
    ...
    unsafe {
        if v < 0x80 as u32_0 {
            *zOut.offset(0 as ::core::ffi::c_int as isize) = (v & 0xff as u32_0) as u8_0
                as ::core::ffi::c_char;
            return 1 as ::core::ffi::c_int;
        }
        if v < 0x800 as u32_0 {
            *zOut.offset(0 as ::core::ffi::c_int as isize) = (0xc0 as ::core::ffi::c_int
                + (v >> 6 as ::core::ffi::c_int & 0x1f as u32_0) as u8_0
        ...
        if v < 0x10000 as u32_0 {
            *zOut.offset(0 as ::core::ffi::c_int as isize) = (0xe0 as ::core::ffi::c_int
                + (v >> 12 as ::core::ffi::c_int & 0xf as u32_0) as u8_0
                    as ::core::ffi::c_int) as ::core::ffi::c_char;
            *zOut.offset(1 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
                + (v >> 6 as ::core::ffi::c_int & 0x3f as u32_0) as u8_0
                    as ::core::ffi::c_int) as ::core::ffi::c_char;
        ...
        *zOut.offset(0 as ::core::ffi::c_int as isize) = (0xf0 as ::core::ffi::c_int
            + (v >> 18 as ::core::ffi::c_int & 0x7 as u32_0) as u8_0
                as ::core::ffi::c_int) as ::core::ffi::c_char;
        *zOut.offset(1 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
            + (v >> 12 as ::core::ffi::c_int & 0x3f as u32_0) as u8_0
                as ::core::ffi::c_int) as ::core::ffi::c_char;
        *zOut.offset(2 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
            + (v >> 6 as ::core::ffi::c_int & 0x3f as u32_0) as u8_0
                as ::core::ffi::c_int) as ::core::ffi::c_char;
        *zOut.offset(3 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
            + (v & 0x3f as u32_0) as u8_0 as ::core::ffi::c_int) as ::core::ffi::c_char;
...
pub unsafe extern "C" fn sqlite3Utf8Read(
    ...
    unsafe {
        ...
        let c2rust_fresh1 = *pz;
        *pz = (*pz).offset(1);
        c = *c2rust_fresh1 as ::core::ffi::c_uint;
        if c >= 0xc0 as ::core::ffi::c_uint {
            c = sqlite3Utf8Trans1[c.wrapping_sub(0xc0 as ::core::ffi::c_uint) as usize]
                as ::core::ffi::c_uint;
            while **pz as ::core::ffi::c_int & 0xc0 as ::core::ffi::c_int
                == 0x80 as ::core::ffi::c_int
            {
                let c2rust_fresh2 = *pz;
                *pz = (*pz).offset(1);
                c = (c << 6 as ::core::ffi::c_int)
                    .wrapping_add(
                        (0x3f as ::core::ffi::c_int
                            & *c2rust_fresh2 as ::core::ffi::c_int)
                            as ::core::ffi::c_uint,
                    );
            }
        ...
        if c >= 0xc0 as u32_0 {
                    ...
                    & 0xc0 as ::core::ffi::c_int == 0x80 as ::core::ffi::c_int
            {
                c = (c << 6 as ::core::ffi::c_int)
                    .wrapping_add(
                        (0x3f as ::core::ffi::c_int
                            & *z.offset(i as isize) as ::core::ffi::c_int) as u32_0,
                    );
                i += 1;
            }
        }
...
pub unsafe extern "C" fn sqlite3VdbeMemTranslate(
    ...
    unsafe {
        ...
        let mut zOut: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<
            ::core::ffi::c_uchar,
        >();
        let mut zIn: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<
            ::core::ffi::c_uchar,
        >();
        let mut zTerm: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<
            ::core::ffi::c_uchar,
        >();
            ...
            && desiredEnc as ::core::ffi::c_int != SQLITE_UTF8
        {
            ...
            while zIn < zTerm {
                ...
                *zIn = *zIn.offset(1 as ::core::ffi::c_int as isize);
                zIn = zIn.offset(1);
                let c2rust_fresh3 = zIn;
                zIn = zIn.offset(1);
                *c2rust_fresh3 = temp as ::core::ffi::c_uchar;
            }
            (*pMem).enc = desiredEnc;
        } else {
            if desiredEnc as ::core::ffi::c_int == SQLITE_UTF8 {
                (*pMem).n &= !(1 as ::core::ffi::c_int);
                len = (2 as ::core::ffi::c_longlong
                    * (*pMem).n as ::core::ffi::c_longlong
                    + 1 as ::core::ffi::c_longlong) as sqlite3_int64;
            } else {
                len = (2 as ::core::ffi::c_longlong
                    * (*pMem).n as ::core::ffi::c_longlong
            ...
            zOut = sqlite3DbMallocRaw((*pMem).db, len as u64_0)
                as *mut ::core::ffi::c_uchar;
            if zOut.is_null() {
                return SQLITE_NOMEM_BKPT;
            }
            ...
            if (*pMem).enc as ::core::ffi::c_int == SQLITE_UTF8 {
                if desiredEnc as ::core::ffi::c_int == SQLITE_UTF16LE {
                    while zIn < zTerm {
                        let c2rust_fresh4 = zIn;
                        zIn = zIn.offset(1);
                        c = *c2rust_fresh4 as ::core::ffi::c_uint;
                        if c >= 0xc0 as ::core::ffi::c_uint {
                            c = sqlite3Utf8Trans1[c
                                .wrapping_sub(0xc0 as ::core::ffi::c_uint) as usize]
                                as ::core::ffi::c_uint;
                            while zIn < zTerm
                                && *zIn as ::core::ffi::c_int & 0xc0 as ::core::ffi::c_int
                                    == 0x80 as ::core::ffi::c_int
                            {
                                let c2rust_fresh5 = zIn;
                                zIn = zIn.offset(1);
                                c = (c << 6 as ::core::ffi::c_int)
                                    .wrapping_add(
                                        (0x3f as ::core::ffi::c_int
                        ...
                        if c <= 0xffff as ::core::ffi::c_uint {
                            let c2rust_fresh6 = z;
                            z = z.offset(1);
                            *c2rust_fresh6 = (c & 0xff as ::core::ffi::c_uint) as u8_0
                                as ::core::ffi::c_uchar;
                            let c2rust_fresh7 = z;
                            z = z.offset(1);
                            *c2rust_fresh7 = (c >> 8 as ::core::ffi::c_int
                                & 0xff as ::core::ffi::c_uint) as u8_0
                                as ::core::ffi::c_uchar;
                        } else {
                            let c2rust_fresh8 = z;
                            z = z.offset(1);
                            *c2rust_fresh8 = (c >> 10 as ::core::ffi::c_int
                                & 0x3f as ::core::ffi::c_uint)
                                .wrapping_add(
                                    c
                                        .wrapping_sub(
                                            0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint,
                                        ) >> 10 as ::core::ffi::c_int & 0xc0 as ::core::ffi::c_uint,
                                ) as u8_0 as ::core::ffi::c_uchar;
                            let c2rust_fresh9 = z;
                            z = z.offset(1);
                            *c2rust_fresh9 = (0xd8 as ::core::ffi::c_uint)
                                .wrapping_add(
                                    c
                                        .wrapping_sub(
                                            0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint,
                                        ) >> 18 as ::core::ffi::c_int & 0x3 as ::core::ffi::c_uint,
                                ) as u8_0 as ::core::ffi::c_uchar;
                            let c2rust_fresh10 = z;
                            z = z.offset(1);
                            *c2rust_fresh10 = (c & 0xff as ::core::ffi::c_uint) as u8_0
                                as ::core::ffi::c_uchar;
                            let c2rust_fresh11 = z;
                            z = z.offset(1);
                            *c2rust_fresh11 = (0xdc as ::core::ffi::c_uint)
                                .wrapping_add(
                                    c >> 8 as ::core::ffi::c_int & 0x3 as ::core::ffi::c_uint,
                                ) as u8_0 as ::core::ffi::c_uchar;
                        }
                    }
                } else {
                    while zIn < zTerm {
                        let c2rust_fresh12 = zIn;
                        zIn = zIn.offset(1);
                        c = *c2rust_fresh12 as ::core::ffi::c_uint;
                        if c >= 0xc0 as ::core::ffi::c_uint {
                            c = sqlite3Utf8Trans1[c
                                .wrapping_sub(0xc0 as ::core::ffi::c_uint) as usize]
                                as ::core::ffi::c_uint;
                            while zIn < zTerm
                                && *zIn as ::core::ffi::c_int & 0xc0 as ::core::ffi::c_int
                                    == 0x80 as ::core::ffi::c_int
                            {
                                let c2rust_fresh13 = zIn;
                                zIn = zIn.offset(1);
                                c = (c << 6 as ::core::ffi::c_int)
                                    .wrapping_add(
                                        (0x3f as ::core::ffi::c_int
                                            & *c2rust_fresh13 as ::core::ffi::c_int)
                                            as ::core::ffi::c_uint,
                                    );
                            }
                            if c < 0x80 as ::core::ffi::c_uint
                        ...
                        if c <= 0xffff as ::core::ffi::c_uint {
                            ...
                            z = z.offset(1);
                            *c2rust_fresh14 = (c >> 8 as ::core::ffi::c_int
                                & 0xff as ::core::ffi::c_uint) as u8_0
                                as ::core::ffi::c_uchar;
                            let c2rust_fresh15 = z;
                            z = z.offset(1);
                            *c2rust_fresh15 = (c & 0xff as ::core::ffi::c_uint) as u8_0
                                as ::core::ffi::c_uchar;
                        } else {
                            let c2rust_fresh16 = z;
                            z = z.offset(1);
                            *c2rust_fresh16 = (0xd8 as ::core::ffi::c_uint)
                                .wrapping_add(
                                    c
                                        .wrapping_sub(
                                            0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            ...
                            z = z.offset(1);
                            *c2rust_fresh17 = (c >> 10 as ::core::ffi::c_int
                                & 0x3f as ::core::ffi::c_uint)
                                .wrapping_add(
                                    c
                                        .wrapping_sub(
                            ...
                            z = z.offset(1);
                            *c2rust_fresh18 = (0xdc as ::core::ffi::c_uint)
                                .wrapping_add(
                                    c >> 8 as ::core::ffi::c_int & 0x3 as ::core::ffi::c_uint,
                                ) as u8_0 as ::core::ffi::c_uchar;
                            let c2rust_fresh19 = z;
                            z = z.offset(1);
                            *c2rust_fresh19 = (c & 0xff as ::core::ffi::c_uint) as u8_0
                                as ::core::ffi::c_uchar;
                        }
                    }
                }
                (*pMem).n = z.offset_from(zOut) as ::core::ffi::c_long
                    as ::core::ffi::c_int;
                let c2rust_fresh20 = z;
                z = z.offset(1);
                *c2rust_fresh20 = 0 as ::core::ffi::c_uchar;
            } else {
                if (*pMem).enc as ::core::ffi::c_int == SQLITE_UTF16LE {
                    while zIn < zTerm {
                        let c2rust_fresh21 = zIn;
                        zIn = zIn.offset(1);
                        c = *c2rust_fresh21 as ::core::ffi::c_uint;
                        let c2rust_fresh22 = zIn;
                        zIn = zIn.offset(1);
                        c = c
                            .wrapping_add(
                        ...
                        if c >= 0xd800 as ::core::ffi::c_uint
                            && c < 0xe000 as ::core::ffi::c_uint
                        {
                            if zIn < zTerm {
                                let c2rust_fresh23 = zIn;
                                zIn = zIn.offset(1);
                                let mut c2: ::core::ffi::c_int = *c2rust_fresh23
                                    as ::core::ffi::c_int;
                                let c2rust_fresh24 = zIn;
                                zIn = zIn.offset(1);
                                c2
                                    += (*c2rust_fresh24 as ::core::ffi::c_int)
                                        << 8 as ::core::ffi::c_int;
                                c = ((c2 & 0x3ff as ::core::ffi::c_int)
                                    as ::core::ffi::c_uint)
                                    .wrapping_add(
                        ...
                        if c < 0x80 as ::core::ffi::c_uint {
                            let c2rust_fresh25 = z;
                            z = z.offset(1);
                            *c2rust_fresh25 = (c & 0xff as ::core::ffi::c_uint) as u8_0
                                as ::core::ffi::c_uchar;
                        } else if c < 0x800 as ::core::ffi::c_uint {
                            let c2rust_fresh26 = z;
                            z = z.offset(1);
                            *c2rust_fresh26 = (0xc0 as ::core::ffi::c_int
                                + (c >> 6 as ::core::ffi::c_int
                                    & 0x1f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                            let c2rust_fresh27 = z;
                            z = z.offset(1);
                            *c2rust_fresh27 = (0x80 as ::core::ffi::c_int
                                + (c & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                        } else if c
                            < 0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint
                        {
                            let c2rust_fresh28 = z;
                            z = z.offset(1);
                            *c2rust_fresh28 = (0xe0 as ::core::ffi::c_int
                                + (c >> 12 as ::core::ffi::c_int
                                    & 0xf as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_int)
                                as ::core::ffi::c_uchar;
                            let c2rust_fresh29 = z;
                            z = z.offset(1);
                            *c2rust_fresh29 = (0x80 as ::core::ffi::c_int
                                + (c >> 6 as ::core::ffi::c_int
                                    & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                            let c2rust_fresh30 = z;
                            z = z.offset(1);
                            *c2rust_fresh30 = (0x80 as ::core::ffi::c_int
                                + (c & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                        } else {
                            let c2rust_fresh31 = z;
                            z = z.offset(1);
                            *c2rust_fresh31 = (0xf0 as ::core::ffi::c_int
                                + (c >> 18 as ::core::ffi::c_int
                                    & 0x7 as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_int)
                                as ::core::ffi::c_uchar;
                            let c2rust_fresh32 = z;
                            z = z.offset(1);
                            *c2rust_fresh32 = (0x80 as ::core::ffi::c_int
                                + (c >> 12 as ::core::ffi::c_int
                                    & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                            let c2rust_fresh33 = z;
                            z = z.offset(1);
                            *c2rust_fresh33 = (0x80 as ::core::ffi::c_int
                                + (c >> 6 as ::core::ffi::c_int
                                    & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                            let c2rust_fresh34 = z;
                            z = z.offset(1);
                            *c2rust_fresh34 = (0x80 as ::core::ffi::c_int
                                + (c & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                        }
                    }
                    ...
                    while zIn < zTerm {
                        let c2rust_fresh35 = zIn;
                        zIn = zIn.offset(1);
                        c = ((*c2rust_fresh35 as ::core::ffi::c_int)
                            << 8 as ::core::ffi::c_int) as ::core::ffi::c_uint;
                        let c2rust_fresh36 = zIn;
                        zIn = zIn.offset(1);
                        c = c.wrapping_add(*c2rust_fresh36 as ::core::ffi::c_uint);
                        if c >= 0xd800 as ::core::ffi::c_uint
                            && c < 0xe000 as ::core::ffi::c_uint
                        {
                            if zIn < zTerm {
                                let c2rust_fresh37 = zIn;
                                zIn = zIn.offset(1);
                                let mut c2_0: ::core::ffi::c_int = (*c2rust_fresh37
                                    as ::core::ffi::c_int) << 8 as ::core::ffi::c_int;
                                let c2rust_fresh38 = zIn;
                                zIn = zIn.offset(1);
                                c2_0 += *c2rust_fresh38 as ::core::ffi::c_int;
                                c = ((c2_0 & 0x3ff as ::core::ffi::c_int)
                                    as ::core::ffi::c_uint)
                                    .wrapping_add(
                                        (c & 0x3f as ::core::ffi::c_uint)
                                            << 10 as ::core::ffi::c_int,
                        ...
                        if c < 0x80 as ::core::ffi::c_uint {
                            let c2rust_fresh39 = z;
                            z = z.offset(1);
                            *c2rust_fresh39 = (c & 0xff as ::core::ffi::c_uint) as u8_0
                                as ::core::ffi::c_uchar;
                        } else if c < 0x800 as ::core::ffi::c_uint {
                            let c2rust_fresh40 = z;
                            z = z.offset(1);
                            *c2rust_fresh40 = (0xc0 as ::core::ffi::c_int
                                + (c >> 6 as ::core::ffi::c_int
                                    & 0x1f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                            let c2rust_fresh41 = z;
                            z = z.offset(1);
                            *c2rust_fresh41 = (0x80 as ::core::ffi::c_int
                                + (c & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                        } else if c
                            < 0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint
                        {
                            let c2rust_fresh42 = z;
                            z = z.offset(1);
                            *c2rust_fresh42 = (0xe0 as ::core::ffi::c_int
                                + (c >> 12 as ::core::ffi::c_int
                                    & 0xf as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_int)
                                as ::core::ffi::c_uchar;
                            let c2rust_fresh43 = z;
                            z = z.offset(1);
                            *c2rust_fresh43 = (0x80 as ::core::ffi::c_int
                                + (c >> 6 as ::core::ffi::c_int
                                    & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                            let c2rust_fresh44 = z;
                            z = z.offset(1);
                            *c2rust_fresh44 = (0x80 as ::core::ffi::c_int
                                + (c & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                        } else {
                            let c2rust_fresh45 = z;
                            z = z.offset(1);
                            *c2rust_fresh45 = (0xf0 as ::core::ffi::c_int
                                + (c >> 18 as ::core::ffi::c_int
                                    & 0x7 as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_int)
                                as ::core::ffi::c_uchar;
                            let c2rust_fresh46 = z;
                            z = z.offset(1);
                            *c2rust_fresh46 = (0x80 as ::core::ffi::c_int
                                + (c >> 12 as ::core::ffi::c_int
                                    & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                            let c2rust_fresh47 = z;
                            z = z.offset(1);
                            *c2rust_fresh47 = (0x80 as ::core::ffi::c_int
                                + (c >> 6 as ::core::ffi::c_int
                                    & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                            let c2rust_fresh48 = z;
                            z = z.offset(1);
                            *c2rust_fresh48 = (0x80 as ::core::ffi::c_int
                                + (c & 0x3f as ::core::ffi::c_uint) as u8_0
                                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                        }
                    }
            ...
            *z = 0 as ::core::ffi::c_uchar;
            c = (MEM_Str | MEM_Term
                | (*pMem).flags as ::core::ffi::c_int & (MEM_AffMask | MEM_Subtype))
                as ::core::ffi::c_uint;
            ...
            (*pMem).zMalloc = (*pMem).z;
            (*pMem).szMalloc = sqlite3DbMallocSize(
                (*pMem).db,
...
pub unsafe extern "C" fn sqlite3VdbeMemHandleBom(
    ...
    unsafe {
        ...
        if (*pMem).n > 1 as ::core::ffi::c_int {
            ...
            let mut b2: u8_0 = *((*pMem).z as *mut u8_0)
        ...
        if bom != 0 {
            ...
            if rc == SQLITE_OK {
                ...
                memmove(
                    ...
                    (*pMem).z.offset(2 as ::core::ffi::c_int as isize)
                        as *mut ::core::ffi::c_char as *const ::core::ffi::c_void,
                    (*pMem).n as size_t,
                );
                *(*pMem).z.offset((*pMem).n as isize) = '\0' as i32
                    as ::core::ffi::c_char;
                *(*pMem).z.offset(((*pMem).n + 1 as ::core::ffi::c_int) as isize) = '\0'
                    as i32 as ::core::ffi::c_char;
                (*pMem).flags = ((*pMem).flags as ::core::ffi::c_int | MEM_Term)
                    as u16_0;
                (*pMem).enc = bom;
            }
        }
...
pub unsafe extern "C" fn sqlite3Utf8CharLen(
    ...
    unsafe {
        ...
        while *z as ::core::ffi::c_int != 0 as ::core::ffi::c_int && z < zTerm {
            let c2rust_fresh0 = z;
            z = z.offset(1);
            if *c2rust_fresh0 as ::core::ffi::c_int >= 0xc0 as ::core::ffi::c_int {
...
pub unsafe extern "C" fn sqlite3Utf16ByteLen(
    ...
    unsafe {
        ...
        let mut zEnd: *const ::core::ffi::c_uchar = z
            .offset((nByte - 1 as ::core::ffi::c_int) as isize)
        ...
        while n < nChar && z <= zEnd {
            ...
            if c >= 0xd8 as ::core::ffi::c_int && c < 0xdc as ::core::ffi::c_int
                && z <= zEnd
    ...
    unsafe {
        ...
        while i < 0x110000 as ::core::ffi::c_int as ::core::ffi::c_uint {
            ...
            if i < 0x80 as ::core::ffi::c_uint {
                let c2rust_fresh49 = z;
                z = z.offset(1);
                *c2rust_fresh49 = (i & 0xff as ::core::ffi::c_uint) as u8_0
                    as ::core::ffi::c_uchar;
            } else if i < 0x800 as ::core::ffi::c_uint {
                let c2rust_fresh50 = z;
                z = z.offset(1);
                *c2rust_fresh50 = (0xc0 as ::core::ffi::c_int
                    + (i >> 6 as ::core::ffi::c_int & 0x1f as ::core::ffi::c_uint)
                        as u8_0 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                let c2rust_fresh51 = z;
                z = z.offset(1);
                *c2rust_fresh51 = (0x80 as ::core::ffi::c_int
                    + (i & 0x3f as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_int)
                    as ::core::ffi::c_uchar;
            } else if i < 0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint {
                let c2rust_fresh52 = z;
                z = z.offset(1);
                *c2rust_fresh52 = (0xe0 as ::core::ffi::c_int
                    + (i >> 12 as ::core::ffi::c_int & 0xf as ::core::ffi::c_uint)
                        as u8_0 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                let c2rust_fresh53 = z;
                z = z.offset(1);
                *c2rust_fresh53 = (0x80 as ::core::ffi::c_int
                    + (i >> 6 as ::core::ffi::c_int & 0x3f as ::core::ffi::c_uint)
                        as u8_0 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                let c2rust_fresh54 = z;
                z = z.offset(1);
                *c2rust_fresh54 = (0x80 as ::core::ffi::c_int
                    + (i & 0x3f as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_int)
                    as ::core::ffi::c_uchar;
            } else {
                let c2rust_fresh55 = z;
                z = z.offset(1);
                *c2rust_fresh55 = (0xf0 as ::core::ffi::c_int
                    + (i >> 18 as ::core::ffi::c_int & 0x7 as ::core::ffi::c_uint)
                        as u8_0 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                let c2rust_fresh56 = z;
                z = z.offset(1);
                *c2rust_fresh56 = (0x80 as ::core::ffi::c_int
                    + (i >> 12 as ::core::ffi::c_int & 0x3f as ::core::ffi::c_uint)
                        as u8_0 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                let c2rust_fresh57 = z;
                z = z.offset(1);
                *c2rust_fresh57 = (0x80 as ::core::ffi::c_int
                    + (i >> 6 as ::core::ffi::c_int & 0x3f as ::core::ffi::c_uint)
                        as u8_0 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                let c2rust_fresh58 = z;
                z = z.offset(1);
                *c2rust_fresh58 = (0x80 as ::core::ffi::c_int
                    + (i & 0x3f as ::core::ffi::c_uint) as u8_0 as ::core::ffi::c_int)
                    as ::core::ffi::c_uchar;
            }
            n = z.offset_from(&raw mut zBuf as *mut ::core::ffi::c_uchar)
                as ::core::ffi::c_long as ::core::ffi::c_int;
            *z.offset(0 as ::core::ffi::c_int as isize) = 0 as ::core::ffi::c_uchar;
            z = &raw mut zBuf as *mut ::core::ffi::c_uchar;
            c = sqlite3Utf8Read(&raw mut z as *mut *const ::core::ffi::c_uchar)
                as ::core::ffi::c_uint;
            t = i;
