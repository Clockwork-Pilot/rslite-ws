...
unsafe extern "C" fn whereClauseInsert(
    ...
    unsafe {
        ...
        if !p.is_null()
            && (*p).flags & 0x80000 as ::core::ffi::c_int as u32_0 != 0 as u32_0
        {
    ...
    unsafe {
                ...
                != sqlite3BinaryCompareCollSeq(pParse, (*pExpr).pRight, (*pExpr).pLeft)
        {
            (*pExpr).flags = ((*pExpr).flags as ::core::ffi::c_uint
                ^ EP_Commuted as ::core::ffi::c_uint) as u32_0;
        }
    ...
    unsafe {
        if !pDerived.is_null()
            && (*pBase).flags
                ...
                != 0 as u32_0
        {
            (*pDerived).flags = ((*pDerived).flags as ::core::ffi::c_uint
                | ((*pBase).flags & (EP_OuterON | EP_InnerON) as u32_0)
            ...
            if (*pExpr).pLeft.is_null()
                || (*pExpr).flags
                    & (0x1000 as ::core::ffi::c_int | 0x40000 as ::core::ffi::c_int)
                        as u32_0 != 0 as u32_0 || !(*pExpr).x.pList.is_null()
            {
            ...
            loop {
                ...
                if prereqExpr & prereqColumn == 0 as ::core::ffi::c_ulonglong {
                    ...
                    if (*pExpr).flags & 0x1 as ::core::ffi::c_int as u32_0 != 0 as u32_0
                        && !pNewExpr_1.is_null()
                    {
                        (*pNewExpr_1).flags = ((*pNewExpr_1).flags as ::core::ffi::c_uint
...
unsafe extern "C" fn whereAddLimitExpr(
    ...
    unsafe {
            ...
            && iVal >= 0 as ::core::ffi::c_int
        {
            ...
            (*pVal).flags = ((*pVal).flags as ::core::ffi::c_uint
                | 0x800 as ::core::ffi::c_int as u32_0 as ::core::ffi::c_uint) as u32_0;
            (*pVal).u.iValue = iVal;
